    ...
    <section id="step3" style="display: none;">
        <div class="container-wrap">
            <div class="fill-list-module resetfill-list">
                ...
                <%--<div class="list-wrap">--%>
                    <%--<div class="list-item"><span class="item-input-wrap" id="stp2-1-oneMoney"></span><span--%>
                            <%--class="item-name">单个红包金额</span></div>--%>
                <%--</div>--%>
                <%--<div class="list-wrap">--%>
                    <%--<div class="list-item"><span class="item-input-wrap" id="stp2-1-bagSize"></span><span--%>
                            <%--class="item-name">红包个数</span></div>--%>
                <%--</div>--%>
                <div class="list-wrap">
