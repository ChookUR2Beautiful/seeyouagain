    ...
    <section id="step2" style="display: none;">
        <div class="container-wrap">
            <div class="fill-list-module">
                ...
                <div class="list-wrap">
                    <div class="list-item"><span class="item-input-wrap"><input name="sumName" type="text" class="amount" placeholder="请填写5000元以内的金额" id="redmoney"/></span><span class="item-name">单个红包金额</span></div>
                </div>
                <div class="list-wrap">
                    <div class="list-item"><span class="item-input-wrap"><input name="sizeName" type="text" class="amount" placeholder="填写个数" id="rednum"/>&nbsp;个</span><span class="item-name">红包个数</span></div>
                </div>
                <div class="list-divhead">领取条件</div>
                <div class="list-wrap">
                    <div class="list-item"><span class="item-input-wrap">支付<input name="payName" type="text" class="amount" id="getcondition"/>&nbsp;元以上可领取</span><span class="item-name">领取条件</span></div>
                </div>
            </div>
        </div>
        <div class="floor-module">
