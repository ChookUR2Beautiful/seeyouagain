...
public class MakeOrderNum {
    ...
    public static void main(String[] args) {
        // 测试多线程调用订单号生成工具
        /*
         * try { for (int i = 0; i < 200; i++) { Thread t1 = new Thread(new Runnable() { public void
         * run() { MakeOrderNum makeOrder = new MakeOrderNum(); makeOrder.makeOrderNum(); } });
         * t1.start();
         * 
         * Thread t2 = new Thread(new Runnable() { public void run() { MakeOrderNum makeOrder = new
         * MakeOrderNum(); makeOrder.makeOrderNum(); } }); t2.start(); } } catch (Exception e) {
         * e.printStackTrace(); }
         * 
         * }
         */
