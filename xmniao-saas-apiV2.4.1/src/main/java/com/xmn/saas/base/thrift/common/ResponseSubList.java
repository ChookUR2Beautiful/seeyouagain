            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.subList = new ArrayList<Map<String,String>>(_list10.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ResponseSubList struct) throws org.apache.thrift.TException {
      ...
      if (struct.subList != null) {
        oprot.writeFieldBegin(SUB_LIST_FIELD_DESC);
        {
          ...
          for (Map<String,String> _iter17 : struct.subList)
          {
            {
      ...
      if (struct.isSetSubList()) {
        {
          ...
          for (Map<String,String> _iter19 : struct.subList)
          {
            {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.subList = new ArrayList<Map<String,String>>(_list21.size);
