...
var mySlide = function(a){
    ...
    for ( var i =0; i<tempSize; i++ ){  
        conBox.children[i].children[0].style.cssText="width:"+(clientWidth * widthPercent)+"px;";
        conBox.children[i].style.cssText="display:table-row;height:"+slideW+"px;width:"+(clientWidth * widthPercent)+"px" ;
    }
...
datePicker.prototype.init = function(){
    $('body').append(getmodel('datePickerModel')).addClass('bodyoverflow');
...
timePicker.prototype.init = function(){
    $('body').append(getmodel('timePickerModel')).addClass('bodyoverflow');;
...
selector.prototype.init = function(){
    $('body').append(getmodel('selectorModel')).addClass('bodyoverflow');
    this.addContent();
    setTimeout(function(){$('.timepacker').addClass('bottom-madal-moveup');},1);
}
...
$('#ele').bind('switchchange',function(){
