...
<body class="padd-fill-tb bg-color-01">
    <div class="container-wrap">
       <div class="fill-list-module resetfill-list" >
            ...
            <div class="list-wrap"><div class="list-item"><span class="item-input-wrap">${requestScope.data.address}</span><span class="item-name">可获得位置</span></div></div>
        ...
        <p class="fill-list-desc">到店红包：用户需在指定位置1公里内才能领取红包，以此绑定新用户，并引导用户到店消费，返现回商户手上，获得长期店外收益。</p>
    </div>
