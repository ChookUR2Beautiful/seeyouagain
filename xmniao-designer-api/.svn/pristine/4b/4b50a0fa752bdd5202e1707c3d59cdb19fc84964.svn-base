    ...
    <div class="container-wrap">
        <div class="expendtails-module">
            <div class="expendtails-wrap">
                <div class="expend-user-loge"><img src="${record.head}" id="head" alt="会员头像"/></div>
        ...
        <div class="fill-list-module" >
            ...
            <div class="list-wrap"><div class="list-item"><span class="item-input-wrap">${record.serialNo}</span><span class="item-name">赠品券编码</span></div></div>
