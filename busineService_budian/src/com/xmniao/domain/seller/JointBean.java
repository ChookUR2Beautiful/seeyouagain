...
public class JointBean {
	...
	public JointBean(Integer jointid) {
	...
	public String toString() {
		return "TJoint [jointid=" + jointid + ", corporate=" + corporate
				...
				+ ", imei=" + imei + ", sex=" + sex + ", saasnum=" + saasnum
				+ ", stocknum=" + stocknum + ", saasamount=" + saasamount
				+ ", saasagio=" + saasagio + ", lid=" + lid + ", longitude="
