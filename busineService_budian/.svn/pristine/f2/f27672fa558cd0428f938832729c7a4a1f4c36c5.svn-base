...
public class LedgerMixBean {
	...
	private double liveLedgerMoney=0;	/* 商家直播分账金额 */
	
	private double liveLedgerRatio=0;	/* 商家直播分账比例 */
	...
	public double getLiveLedgerMoney() {
		return liveLedgerMoney;
	}

	public void setLiveLedgerMoney(double liveLedgerMoney) {
		this.liveLedgerMoney = liveLedgerMoney;
	}
	...
	public String toString() {
		return "LedgerMixBean [orderMoney=" + orderMoney + ", userMoney="
				...
				+ consumeJointRatio + ", feeRatio=" + feeRatio
				+ ", ledgerMode=" + ledgerMode + ", liveLedgerMoney="
				+ liveLedgerMoney + ", liveLedgerRatio=" + liveLedgerRatio
				+ "]";
	}
