            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.walletList = new ArrayList<Map<String,String>>(_list10.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WalletRecord struct) throws org.apache.thrift.TException {
      ...
      if (struct.walletList != null) {
        oprot.writeFieldBegin(WALLET_LIST_FIELD_DESC);
        {
          ...
          for (Map<String,String> _iter17 : struct.walletList)
          {
            {
      ...
      if (struct.isSetWalletList()) {
        {
          ...
          for (Map<String,String> _iter19 : struct.walletList)
          {
            {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.walletList = new ArrayList<Map<String,String>>(_list21.size);
