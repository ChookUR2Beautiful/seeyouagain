...
public class GatewayRefundQueryServiceLocator extends org.apache.axis.client.Service implements com.xmniao.kuaiqian.GatewayRefundQueryService {
    ...
    public com.xmniao.kuaiqian.GatewayRefundQuery getgatewayRefundQuery() throws javax.xml.rpc.ServiceException {
    ...
    public com.xmniao.kuaiqian.GatewayRefundQuery getgatewayRefundQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.xmniao.kuaiqian.GatewayRefundQuerySoapBindingStub _stub = new com.xmniao.kuaiqian.GatewayRefundQuerySoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.xmniao.kuaiqian.GatewayRefundQuery.class.isAssignableFrom(serviceEndpointInterface)) {
                com.xmniao.kuaiqian.GatewayRefundQuerySoapBindingStub _stub = new com.xmniao.kuaiqian.GatewayRefundQuerySoapBindingStub(new java.net.URL(gatewayRefundQuery_address), this);
                _stub.setPortName(getgatewayRefundQueryWSDDServiceName());
                return _stub;
            }
        }
