...
import com.xmniao.thrift.ledger.PayRefundService.Client;
 ...
 *
 */
public class PayRefundThriftClient {
    //服务端的IP地址
//    private static final String IP_NUMBER = "192.168.20.242";
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            TMultiplexedProtocol ManagerProtocol = new TMultiplexedProtocol(protocol, "PayRefundService");
            PayRefundService.Client client = new Client(ManagerProtocol);
...
//            RefundRequest refundRequest = new RefundRequest("170309000007",4000.00,"微信退款测试",bid);/*("141225000189",1.00,"微信退款测试");*/
            //汇付退款
            //RefundRequest refundRequest = new RefundRequest("1111111111111",0.10,"汇付退款",bid);
            //钱包退款
            RefundRequest refundRequest = new RefundRequest("170307000081", 100.00,"直播钱包",bid);
//            RefundRequest refundRequest = new RefundRequest("170309000014", 10.00,"余额支付",bid);
            //融宝退款
            ...
            Map resultMap = client.PayRefund(refundRequest);
