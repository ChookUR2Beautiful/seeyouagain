...
public class AgentPayResponse implements Serializable {
	...
	return "AgentPayResponse{" + "batch_no='" + batch_no + '\'' + ", detail_no='" + detail_no + '\'' + ", merchant_id='"
		+ merchant_id + '\'' + ", version='" + version + '\'' + ", sign_type='" + sign_type + '\'' + ", sign='" + sign
		+ '\'' + ", charset='" + charset + '\'' + ", batch_status='" + batch_status + '\'' + ", result_code='"
		+ result_code + '\'' + ", result_msg='" + result_msg + '\'' + ", content='" + content + '\'' + ", next_tag='"
		+ next_tag + '\'' + '}';
    }
}
