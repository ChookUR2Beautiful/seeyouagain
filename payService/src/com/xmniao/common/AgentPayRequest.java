...
/**
 * Created with IntelliJ IDEA. User: Administrator Date: 15-7-20 Time: 下午7:53 代付请求对象类
 */
public class AgentPayRequest implements Serializable {
	...
	return "AgentPayRequest [merchant_id=" + merchant_id + ", version=" + version + ", sign_type=" + sign_type + ", sign="
		+ sign + ", charset=" + charset + ", trans_time=" + trans_time + ", notify_url=" + notify_url + ", batch_no="
		+ batch_no + ", batch_count=" + batch_count + ", batch_amount=" + batch_amount + ", pay_type=" + pay_type
		+ ", content=" + content + ", next_tag=" + next_tag + ", detail_no=" + detail_no + "]";
    }
