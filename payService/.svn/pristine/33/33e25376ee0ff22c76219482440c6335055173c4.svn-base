...
public class RequestHandlerV3 {
	 ...
	 * @param response
	 */
	public RequestHandlerV3(HttpServletRequest request, HttpServletResponse response) {
...
//			}
	...
	protected void createSign() {
		...
		String enc = TenpayUtil.getCharacterEncoding(this.request, this.response);
		String sign = MD5.Encode(sb.toString(), enc).toLowerCase();
