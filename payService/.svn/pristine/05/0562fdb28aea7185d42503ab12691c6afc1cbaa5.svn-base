...
public class UPayNotifyController {
    ...
    public void updateWallet(){
    	...
    	hashMap.put("id", "3524");
		hashMap.put("uId", "609225");
		hashMap.put("zbalance", "0.1");
    	liveWalletMapper.updateWallet(hashMap);
    }
    
    
    @RequestMapping(value = {"/updateBalanceType"}, method = RequestMethod.GET)
    public void updateBalanceType(){
    	HashMap<String,Object> hashMap = new HashMap<>();
		hashMap.put("userType", "1");
		hashMap.put("uId", "609221");
		hashMap.put("commision", "0.01");
		hashMap.put("commision_d", 99999999);
		hashMap.put("zbalance", "0.02");
		hashMap.put("zbalance_d", 999999999);
    	updateWalletBalanceMapper.updateBalanceType(hashMap);
    }
    
    
	@RequestMapping(value = {"/updateWalletBySign"}, method = RequestMethod.GET)
	public void updateWalletBySign(){
		HashMap<String,String> hashMap = new HashMap<String,String>();
		hashMap.put("typeId", "1");
		hashMap.put("uId", "609221");
		hashMap.put("commision", "999999999");
		int updateWalletBySign = walletMapper.updateWalletBySign(hashMap);
		System.out.println("==========="+updateWalletBySign+"============");
	}
	
	@RequestMapping(value = {"/updateWalletMoney"}, method = RequestMethod.GET)
	public void updateWalletMoney(){
		Wallet wallet = new Wallet();
		wallet.setAccountid(65551);
		wallet.setCommision(BigDecimal.valueOf(99999999));
		wallet.setZbalance(BigDecimal.valueOf(9999999));
		int updateWalletBySign = walletMapper.updateWalletMoney(wallet,"11");
		System.out.println("==========="+updateWalletBySign+"============");
	}
	
	@RequestMapping(value = {"/updateWalletMoneyFromXmer"}, method = RequestMethod.GET)
	public void updateWalletMoneyFromXmer(){
		HashMap<String,Object> hashMap = new HashMap<>();
		hashMap.put("accountid", 65551);
		hashMap.put("commision", 99999999);
		int updateWalletBySign = walletMapper.updateWalletMoneyFromXmer(hashMap);
		System.out.println("==========="+updateWalletBySign+"============");
	}
	
	@RequestMapping(value = {"/updateWalletMoneyFromLive"}, method = RequestMethod.GET)
	public void updateWalletMoneyFromLive(){
		HashMap<String,Object> hashMap = new HashMap<>();
		hashMap.put("accountid", "65551");
		hashMap.put("commision", "0.01");
		int updateWalletBySign = walletMapper.updateWalletMoneyFromLive(hashMap);
		System.out.println("==========="+updateWalletBySign+"============");
	}
