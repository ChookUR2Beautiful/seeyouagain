...
public interface LiveWalletMapper {
	 ...
	 * 方法描述：统计鸟豆消费总额
	 * 创建人：jianming
	 * 创建时间：2017年4月13日 下午5:02:45
	 * @param paraMap
	 * @return
	 */
	Long sumBeans(Map<String,String> paraMap);
	 ...
	 * @return
	 */
	List<Map<String,Object>> birdeggIncomeTop(Map<String, Object> objectMap);
	 ...
	 * 方法描述：统计鸟币总额
	 * 创建人：jianming
	 * 创建时间：2017年4月13日 下午5:05:17
	 * @param walletMap
	 * @return
	 */
	BigDecimal sumBirdB(Map<String, String> walletMap);
    ...
    LiveWallet selectLiveWalletBySelected(LiveWallet record);

	int updateByPrimaryKeySelective(LiveWallet record);

	/**
	 * 更新鸟币余额
	 * @param liveWallet
	 * @param oldWallet
	 *@param deductZbalance  @return
	 */
	int updateZbalance(@Param("newWallet") LiveWallet liveWallet, @Param("oldWallet") LiveWallet oldWallet, @Param("deductZbalance") BigDecimal deductZbalance);
	 ...
	 * @param limitBalacne
	 */
	int updateLimitBalane(@Param("liveWallet") LiveWallet liveWallet, @Param("limitBalacne") BigDecimal limitBalacne);

	LiveWallet getWalletById(Integer walletId);

	LiveWallet getWalletByUid(Integer uid);
	
	Map<String, Object> getzbalanceLockById(Integer walletId);

	Map<String, Object> getzbalanceLockByUid(Integer uid);
	
	
	List<LiveWallet> getLiveWalletByUids(@Param("uids")List<String> uids);
}
