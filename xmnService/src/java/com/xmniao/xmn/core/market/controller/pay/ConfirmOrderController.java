...
* @Description:确认收货接口   
* @author: liuzhihao   
* @date: 2017年1月3日 下午4:24:39
 */
@RequestMapping("/api/v1/market/pay")
@Controller
public class ConfirmOrderController implements BaseVControlInf{
	...
	@RequestMapping(value="/confirm/order",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	public Object directOrder(OrderNoRequest orderNoRequest){
		//验证数据
	...
	public Object versionOne(Object object){
		...
		return marketOrderService.confirmOrder(orderNoRequest);
	}
