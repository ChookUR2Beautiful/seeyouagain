...
* @ClassName: ChangePayTypeController    
* @Description:选择支付方式接口   
* @author: liuzhihao   
* @date: 2017年1月3日 下午1:49:08
 */
@RequestMapping("/api/v1/market/pay")
@Controller
public class ChangePayTypeController implements BaseVControlInf{
	...
	@RequestMapping(value="/change/type",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	...
	public Object versionOne(Object object){
		...
		return marketOrderService.changePayType(changePayTypeRequest);
	}
