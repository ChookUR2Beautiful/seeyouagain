...
public class FreshOrderProcessViewApi implements BaseVControlInf{

private final Logger log = Logger.getLogger(FreshOrderProcessViewApi.class);
	...
	public Object versionOne(Object obj){
		...
		return orderProcessService.queryOrderView(orderProcessInfoRequest);
	}
