...
import com.xmniao.xmn.core.api.controller.vod.CreateClassApi;
...
@Controller
@RequestMapping("/live")
public class PushAnchorApi{
	
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(PushAnchorApi.class);
	...
	private PushService pushService;
		...
		@RequestMapping(value="/pushAnchor",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
		@ResponseBody
		public Object pushUrs(PushUrsRequest request){
			...
			return pushService.pushAnchor(request);
