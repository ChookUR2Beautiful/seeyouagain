...
@RequestMapping("/home")
@Controller
public class HomeCommentApi implements BaseVControlInf{
	...
	@ResponseBody
	public Object getBestForYou(HomeCateCommetRequest request){
		//验证请求数据
	...
	public Object versionOne(Object object){
		HomeCateCommetRequest request = (HomeCateCommetRequest) object;
		return xmnHomeService.getCommentSellers(request);
	}
