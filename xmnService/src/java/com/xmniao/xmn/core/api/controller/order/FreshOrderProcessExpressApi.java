...
public class FreshOrderProcessExpressApi implements BaseVControlInf{

private final Logger log = Logger.getLogger(FreshOrderProcessExpressApi.class);
	...
	public Object versionOne(Object obj){
		...
		return freshOrderProcessService.queryOrderExpress(orderProcessInfoRequest);
	}
