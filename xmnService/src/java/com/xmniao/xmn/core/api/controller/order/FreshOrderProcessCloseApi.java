...
@Controller
public class FreshOrderProcessCloseApi implements BaseVControlInf{

private final Logger log = Logger.getLogger(FreshOrderProcessCloseApi.class);
	...
	public Object versionOne(Object obj){
		...
		return orderProcessService.editOrderForClose(orderProcessInfoRequest);
	}
