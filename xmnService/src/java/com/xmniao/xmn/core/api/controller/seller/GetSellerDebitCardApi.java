...
public class GetSellerDebitCardApi implements BaseVControlInf{
	...
	public Object list(GetCardSellerRquest request){
	...
	private Object versionOne(Object object) {
		GetCardSellerRquest rq = (GetCardSellerRquest) object ;			
		return userDebitCardService.getCardSeller(rq);
	}
