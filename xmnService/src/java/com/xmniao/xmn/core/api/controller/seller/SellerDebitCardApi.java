...
public class SellerDebitCardApi implements BaseVControlInf{
	...
	@ResponseBody
	@RequestMapping("/debitCardList")
	public Object list(UserDebitCardSellerRquest request){
	...
	private Object versionOne(Object object) {
		UserDebitCardSellerRquest rq = (UserDebitCardSellerRquest) object ;			
		return userDebitCardService.userGeTDebitCardList(rq);
	}
