...
@Controller
public class BillOrderQueryApi  implements BaseVControlInf {

	private final Logger log = Logger.getLogger(BillOrderQueryApi.class);
	...
	@RequestMapping(value="/bill/order/query",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	...
	private Object versionControlOne(Object object) {
		...
		//获取uid
		return billOrderInfoService.queryBillOrderView(billOrderQueryRequest);
	}
