...
@Controller
public class BillOrderCancelApi  implements BaseVControlInf {

	private final Logger log = Logger.getLogger(BillOrderCancelApi.class);
	...
	@RequestMapping(value="/bill/order/cancle",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	...
	private Object versionControlOne(Object object) {
		...
		//获取uid
		return billOrderInfoService.billOrderCancle(billOrderQueryRequest);
	}
