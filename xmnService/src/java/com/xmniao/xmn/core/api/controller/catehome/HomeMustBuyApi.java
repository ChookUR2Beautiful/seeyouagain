...
@RequestMapping("/home")
@Controller
public class HomeMustBuyApi implements BaseVControlInf{
	 ...
	 * @return
	 */
	@RequestMapping(value="/mustBuy",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	public Object getBestForYou(HomeMustBuyRequest request){
		//验证请求数据
	...
	public Object versionOne(Object object){
		HomeMustBuyRequest request = (HomeMustBuyRequest) object;
		return xmnHomeService.getMustBuy(request);
	}
