 ...
 * 
*      
* 类名称：DescribeVodPlayUrls   
* 类描述：   获取视频详细信息
* 创建人：xiaoxiong   
* 创建时间：2016年8月26日 下午4:06:59   
* 修改人：xiaoxiong   
* 修改时间：2016年8月26日 下午4:06:59   
* 修改备注：   
* @version    
*
 */
...
public class DescribeVodPlayUrlsApi implements BaseVControlInf{
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(DescribeVodPlayUrlsApi.class);
	...
	@RequestMapping(value="/DescribeVodPlayUrls",method=RequestMethod.GET,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	...
	private Object versionOne(Object object) {
		DescribeVodPlayUrlsRequest request = (DescribeVodPlayUrlsRequest) object;
		return LiveVodService.DescribeVodPlayUrls(request);
	}
