 ...
 */
@Controller
public class SellerPackageCancelApi implements BaseVControlInf{
	
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(SellerPackageCancelApi.class);
	...
	@RequestMapping(value = "/seller/package/orderCancel" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	...
	public Object versionOne(Object obj){
		...
		return sellerPackageOrderService.cancelSellerPackageOrderInfo(sellerPackageQueryRequest);
	}
