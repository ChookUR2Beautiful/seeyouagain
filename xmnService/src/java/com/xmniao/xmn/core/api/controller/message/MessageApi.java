...
@Controller
public class MessageApi implements BaseVControlInf {
	
	private final Logger log = Logger.getLogger(MessageApi.class);
	...
	@RequestMapping(value="/message/activity",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	public Object addComment(MessageActivityRequest request) {
	...
	public Object versionControlOne(Object obj){
		MessageActivityRequest commentRequest = (MessageActivityRequest) obj;
		return messageService.getUserActivityMessage(commentRequest);
