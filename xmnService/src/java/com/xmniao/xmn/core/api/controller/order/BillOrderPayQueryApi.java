...
@Controller
public class BillOrderPayQueryApi  implements BaseVControlInf {

	private final Logger log = Logger.getLogger(BillOrderPayQueryApi.class);
	...
	@RequestMapping(value="/bill/order/payQuery",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	...
	private Object versionControlOne(Object object) {
		...
		//获取uid
		return billOrderInfoService.queryBillForPaymentService(billOrderQueryRequest);
	}
