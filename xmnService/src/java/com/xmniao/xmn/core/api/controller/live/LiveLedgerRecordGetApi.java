 ...
 */
@Controller
public class LiveLedgerRecordGetApi implements BaseVControlInf{

	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(LiveLedgerRecordGetApi.class);
	...
	* @throws
	 */
	@RequestMapping(value = "/live/ledgerBranch/get" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	...
	public Object versionOne(Object obj){
		...
		return liveRedpacketBranchService.liveRedPacketBranchGot(request);
	}
