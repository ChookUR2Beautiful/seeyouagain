...
* @ClassName: CollectSellerListApi    
* @Description:收藏记录列表   
* @author: liuzhihao   
* @date: 2016年11月23日 下午4:31:59
 */
@RequestMapping("collect")
@Controller
public class CollectSellerListApi implements BaseVControlInf{
	...
	@ResponseBody
	public Object collectSellers(UserSellerRequest userSellerRequest){
	...
	public Object versionOne(Object object){
		...
		if(request.getStatus() == 1){
			...
			List<Map<Object,Object>> collects = userSellerService.querySellerByCollect(request);
			if(collects != null && !collects.isEmpty()){
				map.put("sellers", collects);
			}else {
