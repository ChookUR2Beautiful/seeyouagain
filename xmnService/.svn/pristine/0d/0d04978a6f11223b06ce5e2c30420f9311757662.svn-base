...
private final Logger log = Logger.getLogger(MessageSystemApi.class);
	 ...
	 * 2016-8-10 16:59:03
	 * */
	@RequestMapping(value = "/live/message/messageList" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	...
	public Object versionOne(Object obj){
		...
		return messageManagerService.getSystemMessageList(messageInfoRequest);
	}
