...
*    
* 项目名称：xmnService   
* 类名称：PersonalBalanceInfoApi   
* 类描述：   我的余额信息(点击用户主页的余额)
* 创建人：yezhiyong   
* 创建时间：2016年11月25日 下午2:18:20   
* @version    
*
 */
@RequestMapping("/personal")
@Controller
public class PersonalBalanceInfoApi implements BaseVControlInf{

	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(PersonalBalanceInfoApi.class);
	...
	* @throws
	 */
	@RequestMapping(value = "/personalBalanceInfo" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	...
	public Object versionOne(Object obj){
		...
		return personalInfoService.queryPersonalBalanceInfo(baseRequest);
	}
