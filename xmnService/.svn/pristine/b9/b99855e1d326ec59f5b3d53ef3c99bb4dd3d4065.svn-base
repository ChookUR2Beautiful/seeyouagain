...
@Controller
public class BillOrderListQueryApi  implements BaseVControlInf {

	private final Logger log = Logger.getLogger(BillOrderListQueryApi.class);
	...
	@RequestMapping(value="/bill/order/queryList",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	...
	private Object versionControlOne(Object object) {
		...
		//获取uid
		return billOrderInfoService.queryBillOrderList(billOrderQueryRequest);
	}
