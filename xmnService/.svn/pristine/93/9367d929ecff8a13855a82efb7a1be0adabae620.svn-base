...
*    
* 项目名称：xmnService   
* 类名称：DeleteAnchorManagerApi   
* 类描述：  主播删除指定的管理员
* 创建人：yezhiyong   
* 创建时间：2016年10月19日 上午10:21:20   
* @version    
*
 */
@Controller
public class DeleteAnchorManagerApi implements BaseVControlInf{

	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(DeleteAnchorManagerApi.class);
	...
	* @throws
	 */
	@RequestMapping(value = "/live/anchor/deleteAnchorManager" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	...
	public Object versionOne(Object obj){
		...
		return anchorManagerService.deleteAnchorManager(uidRequest);
	}
