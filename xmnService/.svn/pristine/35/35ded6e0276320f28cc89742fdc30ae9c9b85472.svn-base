 ...
 */
@Controller
public class XmerIdentityApi implements BaseVControlInf{
	
	//日志
	private Logger log = Logger.getLogger(XmerIdentityApi.class);
	...
	@RequestMapping(value="/xmerIdentity",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	...
	private Object versionControlOne(Object object) {
		...
		return xmerService.queryIdentity(baseRequest);
	}
