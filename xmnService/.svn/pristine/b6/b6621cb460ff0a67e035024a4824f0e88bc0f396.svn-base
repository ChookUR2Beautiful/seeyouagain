...
@Controller
public class CouponOrderListQueryApi  implements BaseVControlInf {

	private final Logger log = Logger.getLogger(CouponOrderListQueryApi.class);
	...
	@RequestMapping(value="/coupon/order/queryList",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	@ResponseBody
	...
	private Object versionControlOne(Object object) {
		...
		//获取uid
		return couponFansOrderInfoService.queryCouponOrderList(billOrderQueryRequest);
	}
