...
/**
 * 
* @Description: 购买商家套餐 成功
* @author yhl
* @throws
* 2016年8月15日11:31:15
 */
@Controller
public class SellerPackageQueryListApi implements BaseVControlInf{
	
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(SellerPackageQueryListApi.class);
	...
	@RequestMapping(value = "/seller/package/orderList" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	...
	public Object versionOne(Object obj){
		...
		return sellerPackageOrderService.querySellerPackageOrderList(sellerPackageQueryRequest);
	}
