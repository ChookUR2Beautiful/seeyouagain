...
@Controller
public class ExperienceCardApi {
	/**
	 * 报错日志
	 */
	...
	@RequestMapping(value="/experience/card/buy")
	@ResponseBody
	public Object cardBuy(ExperienceCardRequest experienceCardRequest){
		//验证请求数据的合法性
	...
	private Object versionControl(Object object) {
		...
		//获取uid
		return experienceConfigService.buyExprienceCard(request);
	}
}
