 ...
 */
@Controller
public class MaterialSellerApi implements BaseVControlInf{
	
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(MaterialSellerApi.class);
	...
	@ResponseBody
	@RequestMapping(value="selectMaterialSeller",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	public Object materialpay(BaseRequest request){
		//验证
	...
	private Object version(Object object) {
		...
		return materialService.sellerSuccess(request);
	}
