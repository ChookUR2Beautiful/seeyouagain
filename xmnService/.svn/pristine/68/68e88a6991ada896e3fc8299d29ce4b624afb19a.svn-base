 ...
 */
@Controller
public class LiveSendSellerPackageListApi implements BaseVControlInf {
	
	
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(LiveSendSellerPackageListApi.class);
	...
	@RequestMapping(value = "/live/sendSellerPackage/list" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	public Object querySellerPackageList(LiveGiftsListRequest request){
		//日志
	...
	private Object versionOne(Object object) {
		...
		return liveSendProductGiftsService.querySellerPackageGiftList(request);
	}
