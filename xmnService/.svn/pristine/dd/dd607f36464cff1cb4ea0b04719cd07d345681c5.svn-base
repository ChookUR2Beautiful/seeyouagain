 ...
 */
@Controller
public class SellerPackageQueryApi implements BaseVControlInf{
	
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(SellerPackageQueryApi.class);
	...
	@RequestMapping(value = "/seller/package/orderQuery" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	...
	public Object versionOne(Object obj){
		...
		return sellerPackageOrderService.querySellerPackageOrderInfo(sellerPackageQueryRequest);
	}
