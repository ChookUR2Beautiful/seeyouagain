 ...
 */
@Controller
public class LiveAnchorRoomEntryApi implements BaseVControlInf {
	
	
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(LiveAnchorRoomEntryApi.class);
	...
	@RequestMapping(value = "/live/anchor/entryRoom" ,method=RequestMethod.POST,produces={"application/json;charset=utf-8"})
	@ResponseBody
	...
	private Object versionOne(Object object) {
		...
		return liveAnchorRoomService.userEntryRoom(liverRoomRequest);
	}
