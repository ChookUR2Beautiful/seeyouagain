...
public class DebitCardTipApi implements BaseVControlInf{
	
	/**
	 * 日志
	 */
	private final Logger log = Logger.getLogger(DebitCardTipApi.class);
	...
	@ResponseBody
	@RequestMapping("/cardTip")
	public Object list(TipRequest request){
	...
	private Object versionOne(Object object) {
		TipRequest rq = (TipRequest) object ;			
		return userDebitCardService.showcardTip(rq);
	}
