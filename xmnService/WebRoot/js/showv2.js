...
confirmDiag.prototype.init = function(){
	var diaHtml = '<div class="confirmdiagmodal"></div><div class="confirmdiag-box"><p class="confirmdiag-tips">'+this.content+'</p><a class="confirmdiag-btn" href="javascript:;" data-ajax="false">打开App</a></div>';
	$('body').append(diaHtml);
	var _this = this;
...
function dialogWithbtn(options){
	this.content = options.content || '请输入提示内容';
	this.confirmTxt = options.confirmTxt || '确认兑换';
...
dialogWithbtn.prototype.init = function(){
	var diaHtml = '<div class="confirmdiagmodal"></div><div class="dialogwithbtn-box"><p class="dialogwithbtn-tips">'+this.content+'</p><div class="dialogwithbtn-btnbox"><a href="javascript:;" class="dialogwithbtn-cancel" data-ajax="false">取消</a><a href="javascript:;" class="dialogwithbtn-confirm" data-ajax="false">打开App</a></div></div>';
	$('body').append(diaHtml);
	var _this = this;
