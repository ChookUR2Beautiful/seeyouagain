	...
	public Resultable saveRobotSet(TLiveRobotSet robotSet) {
		...
		try {
			...
			if(recordId!=null){
				...
				redisTemplate.opsForHash().putAll(LiveConstant.LIVE_ROBOT_SET_KEY+"common", MapBeanUtil.convertMap(robotSet, "robotSetMixNums","robotSetMaxNums","robotMinNums","robotMaxNums","multiple"));
			}
