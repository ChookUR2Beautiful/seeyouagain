...
public interface AllBillDao extends BaseDao<Bill>{
	...
	/**
	 * 方法描述：查询V客签约店铺消费订单明细 <br/>
	 * 创建人： Administrator <br/>
	 * 创建时间：2017年8月9日下午6:20:11 <br/>
	 * @param liveGivedGiftVke
	 * @return
	 */
	@DataSource("slave")
	public List<TLiveGivedGiftVke> getVerProfitCountSellerList(TLiveGivedGiftVke liveGivedGiftVke);
	
	
	/**
	 * 方法描述：统计V客签约店铺消费订单总数 <br/>
	 * 创建人： Administrator <br/>
	 * 创建时间：2017年8月10日上午9:57:05 <br/>
	 * @param liveGivedGiftVke
	 * @return
	 */
	@DataSource("slave")
	public Long countVerProfitBill(TLiveGivedGiftVke liveGivedGiftVke);
	
	@DataSource("slave")
	Integer getVkeProfitVkeCount(Map<String, Object> params);
	
	@DataSource("slave")
	Integer getVkeProfitSellerCount(Map<String, Object> params);
