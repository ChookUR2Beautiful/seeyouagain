...
//            List<TCoupon> couponsList = request.convertCouponList();
    ...
    public ModelAndView userList(String users){
        String[] unames = users.split("\\s+");
        ...
        for (String uname : unames) {
            ...
            if (burs != null){
                ...
                Map<String, String> userInfo = MapBeanUtil.convertMap(burs, "uid", "uname", "nname");
                Map<String, Object> rankInfo = couponService.queryUserRank(burs);
                userInfo.put("rankName",rankInfo!= null ? rankInfo.get("rankName").toString() : "");
        ...
        return new ModelAndView("coupon/couponissue/user-list",context);
    }
}
