            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pageList = new ArrayList<Map<String,String>>(_list38.size);
      ...
      if (struct.isSetPageList()) {
        {
          ...
          for (Map<String,String> _iter47 : struct.pageList)
          {
            {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.pageList = new ArrayList<Map<String,String>>(_list49.size);
