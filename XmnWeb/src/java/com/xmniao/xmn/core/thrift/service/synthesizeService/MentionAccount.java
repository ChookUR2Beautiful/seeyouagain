            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.accountList = new ArrayList<Map<String,String>>(_list0.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MentionAccount struct) throws org.apache.thrift.TException {
      ...
      if (struct.accountList != null) {
        oprot.writeFieldBegin(ACCOUNT_LIST_FIELD_DESC);
        {
          ...
          for (Map<String,String> _iter7 : struct.accountList)
          {
            {
      ...
      if (struct.isSetAccountList()) {
        {
          ...
          for (Map<String,String> _iter9 : struct.accountList)
          {
            {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.accountList = new ArrayList<Map<String,String>>(_list11.size);
          for (int _i12 = 0; _i12 < _list11.size; ++_i12)
          {
            ...
            struct.accountList.add(_elem13);
          }
        }
        struct.setAccountListIsSet(true);
      }
