...
public class BursService{
	 ...
	 * 方法描述：获取用户数量 <br/>
	 * 创建人：  huang'tao <br/>
	 * 创建时间：2017-8-16下午5:41:04 <br/>
	 * @param burs
	 * @return
	 */
	public long count(Burs burs){
		return bursDao.count(burs);
	}
	...
	/**
	 * 方法描述：获取用户用户列表(包含钱包信息) <br/>
	 * 创建人：  huang'tao <br/>
	 * 创建时间：2017-8-17上午11:31:09 <br/>
	 * @param burs
	 * @return
	 */
	public List<Burs> getUrsWalletListInfo(Burs burs) {
		// TODO Auto-generated method stub
		List<Burs> ursList = getUrsList(burs);
