...
public class BXmerController extends BaseController {
	...
	public void export2(XmerInfoBean xmerInfoBean, HttpServletRequest request, HttpServletResponse response) throws FileNotFoundException, IOException {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("list", bxmerService.exportOtherXmerList(xmerInfoBean));
		
		String fileName = "xmermanagerment/xmerList.xls";
		if(xmerInfoBean.getObjectOriented()!=null){
			switch (xmerInfoBean.getObjectOriented()) {
			case 5:
				break;
			case 7:
				fileName = "xmermanagerment/verxmerList.xls";		
				break;
			case 8:
				fileName = "xmermanagerment/ecxmerList.xls";
				break;
			case 6:
				fileName = "xmermanagerment/versendxmerList.xls";
				break;
			default:
				break;
			}
