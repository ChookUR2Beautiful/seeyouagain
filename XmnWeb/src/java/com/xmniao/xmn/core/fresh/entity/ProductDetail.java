...
public class ProductDetail extends BaseEntity{
	...
	public String toString() {
		return "ProductDetail [fid=" + fid + ", codeId=" + codeId + ", pic1="
				+ pic1 + ", pic2=" + pic2 + ", pic3=" + pic3 + ", pic4=" + pic4
				+ ", pic5=" + pic5 + ", delivery=" + delivery + ", postnote="
				+ postnote + ", servicenote=" + servicenote + ", img1=" + img1
				+ ", img2=" + img2 + ", img3=" + img3 + ", img4=" + img4
				+ ", img5=" + img5 + ", img6=" + img6 + ", img7=" + img7
				+ ", img8=" + img8 + ", img9=" + img9 + ", img10=" + img10
				+ ", img11=" + img11 + ", img12=" + img12 + ", rdate=" + rdate
				+ ", udate=" + udate + ", sort=" + sort + ", remarks="
				+ remarks + ", html=" + html + "]";
	}
