...
$(document).ready(function() {
	saasOrderList = $('#saasOrderList3').page({
		url : 'xmer/manage/saasorder/init/list.jhtml',
		success : success3,
		pageBtnNum :10,
		pageSize:15,
		paramForm : 'saasOrderFormId3'
	});
...
function success3(data, obj) {
	...
	var callbackParam="isBackButton=true&callbackParam="+getFormParam($("#saasOrderFormId3").serialize());
...
$("#export3").click(function(){
		...
		$form = $("#saasOrderFormId3").attr("action",url);
		$form[0].submit();
	});
