...
$(document).ready(function() {
	vipCardList = $('#prepaidList').page({
		url : 'fresh/card/prepaidList.jhtml',
		success : success,
		pageBtnNum :10,
		pageSize:15,
	...
	inserTitle(' > 生鲜会员卡管理 > <a href="fresh/card/prepaidListView.jhtml" target="right">会员卡充值记录</a>','allbillSpan',true);
...
function success(data, obj) {
	...
	var captionInfo = '<caption style="background:#EED8D8; text-align:center; color:#703636; font-size:16px; line-height:40px;"><font style="float:left;">&nbsp;&nbsp;生鲜会员卡充值记录</font></caption>';
