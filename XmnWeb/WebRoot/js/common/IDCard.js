...
genders: {male:"男",female:"女"},
	...
	/**
	 * 检查中国全部区域（包括港、澳、台）的身份证
	 */
	checkAllIdCardNo : function idCard(idCard){
		var hk = /^[a-zA-Z]{1,2}\d{6}\([0-9a-zA-Z]\)$/.test(idCard);//香港身份证，例如：p194357(2)
		var tw = /^[a-zA-Z][0-9]{9}$/.test(idCard);//台湾身份证，例如：H180579397
		var mo = /^[1|5|7][0-9]{6}\([0-9Aa]\)/.test(idCard);//澳门身份证，例如：5215299(8)
		var mainland = idCardNoUtil.checkIdCardNo(idCard);//大陆身份证，例如：
