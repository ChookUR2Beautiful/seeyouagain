 ...
 * 发放奖励前校验
 */	
function rewardSendBefore(){
//	debugger;
	console.log(enrollList1.getIds());
	var tempArray=new Array();
	var datas=enrollList1.getCheckDatas();
	...
	var userItems = JSON.stringify(tempArray);
	if(!enrollList1.getIds()){
		showWarningWindow("warning","请至少选择一条记录！");
		return false;
	}else{
		var url="VstarPlayerRank/manage/reward/rewardSend/init.jhtml";
		var param="?userItems="+userItems;
