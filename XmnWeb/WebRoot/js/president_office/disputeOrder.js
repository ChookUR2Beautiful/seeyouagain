...
$(document).ready(function() {
	divideList = $('#divide').page({
		url : 'president_office/disputeOrder/init/list.jhtml',
...
//		location.reload();
	...
	$('#divideAgree').click(function() {
		if(!divideList.getIds()){
			showWarningWindow("warning","请至少选择一条记录！");
			return;
		}
		var modalTrigger = new ModalTrigger({
			type : 'ajax',
			url : 'president_office/disputeOrder/updateStatus/init.jhtml?type=divide&stateType=1&ids=' + divideList.getIds(),
			toggle : 'modal'
		});
		modalTrigger.show();
	});
	
	$('#divideDisagree').click(function() {
		if(!divideList.getIds()){
			showWarningWindow("warning","请至少选择一条记录！");
			return;
		}
		var modalTrigger = new ModalTrigger({
			type : 'ajax',
			url : 'president_office/disputeOrder/updateStatus/init.jhtml?type=divide&stateType=0&ids=' + divideList.getIds(),
			toggle : 'modal'
		});
		modalTrigger.show();
	});
	...
	$('#withdrawAgree').click(function() {
		if(!withdrawList.getIds()){
			showWarningWindow("warning","请至少选择一条记录！");
			return;
		}
		var modalTrigger = new ModalTrigger({
			type : 'ajax',
			url : 'president_office/disputeOrder/updateStatus/init.jhtml?type=withdraw&stateType=1&ids=' + divideList.getIds(),
			toggle : 'modal'
		});
		modalTrigger.show();
	});
	...
	$('#withdrawDisagree').click(function() {
		...
		var modalTrigger = new ModalTrigger({
			type : 'ajax',
			url : 'president_office/disputeOrder/updateStatus/init.jhtml?type=withdraw&stateType=0&ids=' + divideList.getIds(),
			toggle : 'modal'
		});
		modalTrigger.show();
	});
	...
	inserTitle(' > 总裁办  > <a href="president_office/disputeOrder/init.jhtml" target="right"> 争议订单管理</a>','disputeOrder',true);
});
	...
	obj.find('div').eq(0).scrollTablel({
			...
			handleCols : {
					...
					cols : [{
						...
						linkInfo : {
							modal : {
								url : "president_office/disputeOrder/updateStatus/init.jhtml",// url
				        ...
				        customMethod : function(value, data) {
					    	var $a = $(value);
					    	return $a.attr("data-url",$a.attr("data-url")+'&agree=2&stateType=1')[0].outerHTML;
					     }
					},{
						title : "不通过",// 标题
						linkInfoName : "modal",
				        ...
				        customMethod : function(value, data) {
					    	var $a = $(value);
					    	return $a.attr("data-url",$a.attr("data-url")+'&agree=1&stateType=1')[0].outerHTML;
					     }
					},{
						title : "通过",// 标题
						linkInfoName : "modal",
				        ...
				        customMethod : function(value, data) {
					    	var $a = $(value);
					    	console.info($a.attr("data-url",$a.attr("data-url")+'&agree=0&stateType=1')[0].outerHTML);
					    	return $a.attr("data-url",$a.attr("data-url")+'&agree=0&stateType=1')[0].outerHTML;
					     }
					}] 
		  },
			 //数据行
...
//				html.push('<td>');
//				if(permissions.xg){
//					html.push('<a href="javascript:" data-type="ajax" data-url="president_office/disputeOrder/updateStatus/init.jhtml?agree=0&stateType=1&stateId='+data.content[i].stateId+'&id='+data.content[i].id+'" data-toggle="modal">通过</a>&nbsp;&nbsp;');
//					html.push('<a href="javascript:" data-type="ajax" data-url="president_office/disputeOrder/updateStatus/init.jhtml?agree=1&stateType=1&stateId='+data.content[i].stateId+'&id='+data.content[i].id+'" data-toggle="modal">不通过</a>&nbsp;&nbsp;');
//					html.push('<a href="javascript:" data-type="ajax" data-url="president_office/disputeOrder/updateStatus/init.jhtml?agree=2&stateType=1&stateId='+data.content[i].stateId+'&id='+data.content[i].id+'" data-toggle="modal">销毁</a>&nbsp;&nbsp;');
//				}
//				html.push('</td>');
//			}
	...
	obj.find('div').eq(0).scrollTablel({
			...
			handleCols : {
					...
					cols : [{
					    ...
					    customMethod : function(value, data) {
					    	var $a = $(value);
					    	return $a.attr("data-url",$a.attr("data-url")+'&agree=2&stateType=2')[0].outerHTML;
					   }
					},{
						title : "不通过",// 标题
						linkInfoName : "modal",
				        ...
				        customMethod : function(value, data) {
				    	var $a = $(value);
				    	return $a.attr("data-url",$a.attr("data-url")+'&agree=1&stateType=2')[0].outerHTML;
				     }
					},{
						title : "通过",// 标题
						linkInfoName : "modal",
				        ...
				        customMethod : function(value, data) {
					    	var $a = $(value);
					    	return $a.attr("data-url",$a.attr("data-url")+'&agree=0&stateType=2')[0].outerHTML;
					     }
					}] 
		  },
			 //数据行
...
//				html.push('<td>');
//				if(permissions.xg){
//					html.push('<a href="javascript:" data-type="ajax" data-url="president_office/disputeOrder/updateStatus/init.jhtml?agree=0&stateType=2&stateId='+data.content[i].stateId+'&id='+data.content[i].id+'" data-toggle="modal">通过</a>&nbsp;&nbsp;');
//					html.push('<a href="javascript:" data-type="ajax" data-url="president_office/disputeOrder/updateStatus/init.jhtml?agree=1&stateType=2&stateId='+data.content[i].stateId+'&id='+data.content[i].id+'" data-toggle="modal">不通过</a>&nbsp;&nbsp;');
//					html.push('<a href="javascript:" data-type="ajax" data-url="president_office/disputeOrder/updateStatus/init.jhtml?agree=2&stateType=2&stateId='+data.content[i].stateId+'&id='+data.content[i].id+'" data-toggle="modal">销毁</a>&nbsp;&nbsp;');
//				}
//				html.push('</td>');
//			}
//			html.push('<td>' + (undefined == data.content[i].id ? "-" : data.content[i].id) + '</td>');
