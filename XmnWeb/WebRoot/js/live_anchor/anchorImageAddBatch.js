...
$("#ensureAdd").click(function(){
	...
	if(result){
		...
		var anchorImages=relativePath.split(";");
		$.each(anchorImages,function(n,obj){
			if(obj){
				$("#datas .img-list").append("<li><img src='"+imgRoot+obj+"' /><em class='icon-remove delete-img'></em></li>");
			}
		});
...
function validateCustomer(){
	...
	if(relativePath == null || relativePath==undefined || relativePath==""){
		showWarningWindow("warning","请上传图片 !",9999);
		rsult=false;
		return ;
	}
...
function anchorImageAddBatchInit(){
var $ = jQuery,    // just in case. Make sure it's not an other library. 
	...
	uploader = WebUploader.create({
	    ...
	    accept: {
	        ...
	        mimeTypes: 'image/jpg,png,gif,jpeg,bmp'
	    },
