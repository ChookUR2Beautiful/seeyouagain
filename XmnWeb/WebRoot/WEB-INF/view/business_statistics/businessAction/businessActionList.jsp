  ...
  <body
	...
	<div class="panel">
		<div class="panel-body data">
			<div id="businessActionDiv" request-init ="${requestInit}">
	...
	<script type="text/javascript">
		...
		inserTitle(' > 商家端数据统计 > 商家行为','businessAction',true);
	</script>
