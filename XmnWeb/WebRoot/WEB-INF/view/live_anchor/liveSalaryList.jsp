	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				...
				<button type="button" data-type="ajax" data-width="1000px" data-height="500px"  data-url="liveSalary/fail/init.jhtml" data-toggle="modal"  class="btn btn-warning" id="export" ><span class="icon icon-pencil"></span>&nbsp;手动生成工资条
				<button type="button"  class="btn btn-warning" id="manual" ><span class="icon icon-pencil"></span>&nbsp;手动生成上月工资
			</div>
