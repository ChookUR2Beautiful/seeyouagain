...
<div id="main">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">基本信息</div>
					<div class="panel-body">
						...
						<input type="hidden"  name="addOrderRecordToken" value="${addOrderRecordToken}">
						<input type="hidden"  id="targetUrl" value="${targetUrl}">
							...
							<div class="form-group" id="liveTopicDiv">
								<label class="col-md-4 control-label">直播类型：<span
									style="color:red;">*</span></label>
								<div class="col-md-7">
									<input name="liveTopic" value="1" type="radio" ${liveRecord.liveTopic==1||liveRecord.liveTopic==null?"checked":""} ><span style="font-size: 12px;">商家</span>
						...
						<div class="form-group">
							<label class="col-md-4 control-label">接单人数：<span
								style="color: red;">*</span></label>
							<div class="col-md-7">
								<input type="text" class="form-control" name="orderNum" placeholder="接单人数多少人，就会生成多少条任务通告">
							</div>
						</div>
	...
	<script src="<%=path%>/js/live_anchor/orderRecordEdit.js?v=1.0.2"></script>
</body>
</html>
