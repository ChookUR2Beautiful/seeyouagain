...
<body>
	<form id="editFrom" role="form" class="form-horizontal">
		...
		<div class="form-group" id="anchorDiv">
			...
			<div class="col-md-7">
				<select class="form-control" id="id" name="id"
					initValue="${liveRecord.id}" style="width:100%;"></select> <input
					type="hidden" class="form-control" id="nickname" name="nickname"
					value="${liveRecord.nname}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<input type="text" class="form-control" name="sequenceNo" id="sequenceNo"
	...
	<script src="<%=path%>/js/live_anchor/recommendEdit.js"></script>
</body>
</html>
