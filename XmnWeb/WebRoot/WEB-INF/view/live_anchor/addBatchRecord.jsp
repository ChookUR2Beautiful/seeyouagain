					...
					<div class="panel-body">
						...
						<input type="hidden"  name="addBatchToken" value="${addBatchToken}">
							...
							<div class="form-group" style="display:none;">
								<label class="col-md-4 control-label">通告类型：<span
									style="color:red;">*</span></label>
								<div class="col-md-7">
									<input name="advanceDefault" value="1" type="radio" checked="checked" ><span style="font-size: 12px;">指派预告</span>
									<input name="advanceDefault" value="0" type="radio"  ><span style="font-size: 12px;">任务通告</span>
								</div>
							</div>
							<div class="form-group">
							...
							<div id="datas" >
								...
								<div class="anchorModel">
									...
									<div class="form-group" name="anchorList[0].robotMultipleDiv" style="display: none;">
										<label class="col-md-4 control-label">显示倍数：<span
											style="color: red;">*</span></label>
										<div class="col-md-3">
											<input type="text" class="form-control"
												name="anchorList[0].multiple" value="1" onblur="robotNumBlur(this)">
										</div>
									</div>
									<!-- 配置机器人end -->
						...
						<div class="hidden dataTemp">
							...
							<div class="form-group" name="anchorList[Index].robotMultipleDiv" style="display: none;">
								<label class="col-md-4 control-label">显示倍数：<span
									style="color: red;">*</span></label>
								<div class="col-md-3">
									<input type="text" class="form-control"
										name="anchorList[Index].multiple" value="1" onblur="robotNumBlur(this)">
								</div>
							</div>
							<!-- 配置机器人end -->
