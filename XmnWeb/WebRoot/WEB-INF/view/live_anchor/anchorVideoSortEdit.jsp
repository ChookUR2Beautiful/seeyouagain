...
<body>
	<form id="editFrom" role="form" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<input type="text" class="form-control" name="sort" id="sort" placeholder="推荐值越小，排序越靠前"
					value="${anchorVideo.sort}">
			</div>
		</div>
	...
	<script src="<%=path%>/js/live_anchor/anchorVideoSortEdit.js"></script>
</body>
</html>
