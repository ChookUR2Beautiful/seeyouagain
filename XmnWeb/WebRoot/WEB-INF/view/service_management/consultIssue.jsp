...
<input type="hidden" name="issueType" value="0"/>
 <div id="tab2" class="tab-pane">
      <ul id="myTab1" class="nav nav-tabs">
       <h5>选择用户类型:</h5>
	      <li class="active">
	        <a href="#3tab11" data-toggle="tab">会员用户</a>
	      </li>
	      <li class="">
	        <a href="#3tab12" data-toggle="tab">向蜜客</a>
	      </li>
	      <li class="">
	        <a href="#3tab13" data-toggle="tab">商家</a>
	      </li>
	      <li class="">
	        <a href="#3tab14" data-toggle="tab">合作商</a>
	      </li>
	      <li class="">
	        <a href="#3tab15" data-toggle="tab">非注册会员</a>
	      </li>
	    </ul>
	    <div class="tab-content">
	       <div id="3tab11" class="tab-pane in active">
	           <div class="panel">
				<div class="panel-body">
				<table>
					<tr><td>
					<form class="form-horizontal" role="form"  id="membersForm">
						<table style="width:100%;">
							<tbody>
								<tr>
									...
									<td colspan="6"><button type="button" id="membersquery" class="btn btn-default" >&nbsp;查询</button>
									</td>
								</tr>
								<tr>
								   <td colspan="5">
					...
					<tr><td>
						<form class="form-horizontal" role="form"  id="orderQuestionsForm" dependentForm="membersForm">
	        ...
	        <div id="3tab12" class="tab-pane">
		       <div class="panel">
					<div class="panel-body">
					<table >
						<tbody>
							<tr><td>
							<form class="form-horizontal" role="form"  id="guestsSearchForm"> 
							<table style="width:100%;">
								<tbody>
									<tr>
										...
										<td colspan="6"><button type="button" id="guestsMemberquery" class="btn btn-default" >&nbsp;查询</button>
										</td>
									</tr>
									<tr>
								     <td colspan="5">
										<div class="panel panel-default">
											<div id="guestsMemberList"></div>
									    </div>
										</td>
							    	</tr>
								</tbody>
						...
						<tr><td>
						<form class="form-horizontal" role="form"  id="guestsForm" dependentForm = "guestSearchsForm">
							<input type="hidden" name="issueType" value="1"/>
	         ...
	         <div id="3tab13" class="tab-pane">
		       <div class="panel">
					<div class="panel-body">
						<table style="width:100%;">
						  <tbody>
							<tr><td>
							 <form class="form-horizontal" role="form"  id="merchantSearchsForm">
							 <input type="hidden" name="issueType" value="0"/>
						     <input type="hidden" id="userType" name="userType" value="2"/> 
								...
								<tbody>
									<tr>
										...
										<td colspan="6"><button type="button" id="merchantsquery" class="btn btn-default" >&nbsp;查询</button>
										</td>
									</tr>
									<tr>
									   <td colspan="5">
							...
							<tr><td>
							<form class="form-horizontal" role="form"  id="merchantsForm" dependentForm = "merchantSearchsForm">
								<input type="hidden" name="issueType" value="1"/>
							    <input type="hidden" id="userType" name="userType" value="2"/> 
								<table>
								<tbody>
	         ...
	         <div id="3tab14" class="tab-pane">
		       <div class="panel">
					<div class="panel-body">
					<table style="width:100%;">
					<tbody>
					<tr><td>
					  <form class="form-horizontal" role="form"  id="cooperationSearchsForm">
						<table style="width:100%;">
							<tbody>
								<tr>
									...
									<td colspan="6"><button type="button" id="cooperationsquery" class="btn btn-default" >&nbsp;查询</button></td>
								</tr>
								<tr>
								   <td colspan="8">
									<div class="panel panel-default">
										<div id="cooperationsList"></div>
								    </div>
									</td>
								</tr>
							</tbody>
					...
					<tr><td>
					<form class="form-horizontal" role="form"  id="cooperationsForm" dependentForm = "cooperationSearchsForm">
							<input type="hidden" name="issueType" value="1"/>
	         ...
	         <div id="3tab15" class="tab-pane">
		       <div class="panel">
					<div class="panel-body">
					<table>
					<tbody>
					<tr><td>
					 <form class="form-horizontal" role="form"  id="noMemberSearchsForm">
							<table style="width:100%;">
								<tbody>
									<tr>
					...
					<tr><td>
					   <form class="form-horizontal" role="form"  id="noMembersForm" dependentForm = "noMemberSearchsForm">
							<input type="hidden" name="issueType" value="1"/>
