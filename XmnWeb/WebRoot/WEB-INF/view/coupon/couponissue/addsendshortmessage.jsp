...
<body style="overflow-x: auto;overflow-y: auto;background:#EEE" 	class="doc-views with-navbar">
		...
		<div class="panel-body">
			...
			<input type="hidden" name="status" value="2">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<select  name="tCouponIssueRefs[0].cid" class="form-control">
               ...
               <!-- <div class="form-group">
					...
					<div class="col-md-5">
					           <input type="text" name="tCouponIssueRefs[0].issueVolume" class="form-control" >
					</div>
				</div>  -->
	...
	var dateCount = 0, cityCount = 0, dateSize = 10, citySize = 10
		$(function() {
			inserTitle(
					' >优惠券管理 > <span><a href="coupon/couponissue/init.jhtml.jhtml" target="right">优惠券发放管理</a> >添加短信发送优惠券',
					'couponList', true)
...
'tCouponIssueRefs[0].issueVolume':{
		...
		function formAjax() {
			...
			var url = "coupon/couponissue/sendshortmessage/add.jhtml?activityType=3";
			$.ajax({
				type : 'post',
				url : url,
				data : data,
