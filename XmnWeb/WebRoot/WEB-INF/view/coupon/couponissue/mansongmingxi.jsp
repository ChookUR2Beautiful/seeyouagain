...
<html lang="zh-CN">
  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
								...
								<tbody>
									<tr>
										...
										<td style="width:25%;"><input type="text"
											...
											style="width:40%;float:left"> <label
											style="float: left;">&nbsp;--&nbsp;</label> <input
											type="text" class="form-control form-datetime"
											name="getTimeEnd" style="width:40%;float:left"></td>
									</tr>
									<tr>
										...
										<td style="width:25%;"><input type="text"
											...
											style="float: left;">&nbsp;--&nbsp;</label> <input
											type="text" class="form-control form-datetime"
											name="dateIssueEnd" style="width:40%;float:left"></td>
									</tr>
									<tr>
										...
										<td colspan="2"><div class="submit" style="margin-right: 45px;">
												<input class="submit radius-3" type="button" value="查询全部"
													data-bus='query' style="width: 212px;"/><input class="reset radius-3"
													type="reset" value="重置全部" data-bus='reset' style="width: 212px;"/>
											</div></td>
									</tr>
								</tbody>
							</table>
	...
	inserTitle(' > 优惠券管理  > <a href="coupon/couponissue/mansongmingxi/init.jhtml" target="right">满就送明细</a>','activityManagement',true);
	...
	<script src="<%=path%>/js/coupon/couponissue/mansongmingxi.js"></script>
  </body>
</html>