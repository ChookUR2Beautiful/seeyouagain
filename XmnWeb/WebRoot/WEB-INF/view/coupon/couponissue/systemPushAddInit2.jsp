...
<body>
      ...
      <form id="submitForm" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <textarea id="import-users" class="form-control" rows="5" name="users"></textarea>
            <input type="button" id="matching-users" class="btn"  value="匹配用户"/>
            <span id ='matchedUserNum'></span>
          </div>
        </div>
        <div group="members">
  ...
  <form action="coupon/couponissue/userList.jhtml" id="user-list-from" method="post" target="user-list-win" style="display:none;">
