  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
			...
			<form class="form-horizontal" role="form"  id="searchForm">
				<table style="width:100%;">
					<tbody>
						...
						<input type="hidden" id="isPresidentHandle" name="isPresidentHandle"  value="${param.isPresidentHandle}"/>
							<td style="width:5%;"><h5>用户昵称:</h5></td>
							<td style="width:25%;"><input type="text" class="form-control"  name="nname" style = "width:80%;"></td>
							<td style="width:5%;"><h5>订单号:</h5></td>
							<td style="width:25%;"><input type="text" class="form-control"  name="bid" style = "width:80%;"></td>
							...
							<td style="width:25%;">
								...
								<input type="text" name ="zdateEnd" placeholder="yyyy-MM-dd hh:mm" class="form-control form-datetime" style="width:35%;float:left"></td></tr>
							<tr>
							  ...
							  <td style="width:25%;"  >
								<select class="form-control" name="paytype" style = "width:74.5%;">
							...
							<tr>
								<td colspan="6"><div class="submit" style="position:relative;left:-93px; "><input class="submit radius-3" type="button"  value="查询全部"  data-bus = 'query' /><input  class="reset radius-3" type="reset" value="重置全部"   data-bus = 'reset' /></div></td>
							</tr>
					</tbody>
				</table>
			</form>
	...
	<div class="panel panel-default">   
		...
		<div class="btn-group" style="margin-bottom: 5px;">
				...
				<button type="button" class="btn btn-default"  onclick="queryBumen(this,'0');" name="bumen">客服处理</button>&nbsp;&nbsp;
				<button type="button" class="btn btn-default"  onclick="queryBumen(this,'1');" name="bumen">总裁办处理</button>	
			</div>
			<div id="refundBillHistoryList"></div>
		</div>
	</div>	
	<jsp:include page="../common.jsp"></jsp:include>
	<script src="<%=path%>/js/billmanagerment/refundBillHistoryList.js"></script>
