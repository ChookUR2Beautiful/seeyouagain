...
<body class="doc-views with-navbar">
	...
	<form class="form-horizontal" id="foodClassAddForm">
		<input type="hidden" name="sellerId" value="${sellerId}">
		<div class="form-group">
			<label class="col-md-3 control-label">分类名称:</label>
			<div class="col-md-5">
				<input class="form-control" name="className" placeholder="名称长度15字以内">
			</div>
		</div>
		<!-- <div class="form-group">
	...
	<script type="text/javascript">
		$(function() {
			/* inserTitle(
					'> 商家管理 > <span><a href="businessman/seller/init.jhtml" target="right">商家信息管理</a><span> ><span>添加菜品分类</span>',
					'', true); */
			validate("foodClassAddForm", {
				rules : {
					className : {
						required : true,
						maxlength : 15
		...
		function formAjax() {
			var data = jsonFromt($('#foodClassAddForm').serializeArray());
			$.ajax({
				type : 'post',
				url : "businessman/seller/food/class/add.jhtml" + "?t="
						+ Math.random(),
				data : data,
				dataType : 'json',
