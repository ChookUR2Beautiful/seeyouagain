...
<body class="doc-views with-navbar">
	...
	<form class="form-horizontal" id="foodUpdateForm">
		<input type="hidden" name="id" value="${food.id}"> 
		<input type="hidden" name="sellerId" value="${food.sellerId}">
		<input type="hidden" name="atag" value="${food.atag}">
		...
		<div class="form-group">
			...
			<div class="col-md-5">
				<input class="form-control" name="num" value="${food.num}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-5">
				<input type="hidden" class="form-control" id="picUrl" name="bigPic"
					value="${food.bigPic}" /> <input type="hidden"
					class="form-control" id="breviaryId" name="smallPic"
					value="${food.smallPic}" />
		...
		<div class="form-group">
			...
			<div class="col-md-5">
				<label class="radio-inline">是<input type="radio" value="1"
					name="datastatus"
					<c:if test="${food.datastatus==1}">
							checked="checked"</c:if>></label>
				<label class="radio-inline">否<input type="radio" value="3"
					name="datastatus"
					<c:if test="${food.datastatus==3}"> checked="checked" </c:if>>
				</label>
			</div>
		</div>
		<div class="form-group">
	...
	<%-- <script src="<%=path%>/js/businessman/food/foodUpdate.js"></script> --%>
	<script type="text/javascript">
		$(function() {
			/* inserTitle(
