...
<body
	...
	<input type="hidden" id="path" value="<%=path%>" />
		...
		<div class="panel-body">
			<form class="form-horizontal" role="form"  id="redPackageForm">
				<input type="hidden" name="redPackageId" value="${gRecord.redPackageId}">
				<table style="width:100%;">
					<tbody>
						<tr>
							<td style="width:5%;"><h5>&nbsp;&nbsp;会员id:</h5></td>
							<td style="width:25%;">
							...
							<tr>
							<td style="width:5%;"><h5>&nbsp;&nbsp;会员类型:</h5></td>
							<td style="width:25%;"><select style="width:90%"
									class="form-control" id="redpacketType" name="isBanding">
										<option value="">全部</option>
										<option value="0">消费客户</option>
										<option value="1">绑定会员</option>
								</select></td>
							<td></td>
							<td></td>
	...
	<script src="<%=path%>/js/businessman/redPackage/redPackageDetailList.js"></script>
