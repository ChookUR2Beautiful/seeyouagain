...
<body
					...
					<tbody>
						<tr>
							...
							<td class="col-md-3"><input type="text" class="form-control"
								name="nname"></td>
							<td class="col-md-1"><h5>回复ID：</h5></td>
							<td class="col-md-3"><input type="text" class="form-control"
								name="fid"></td>
						</tr>
						<tr>
							...
							<td class="col-md-3"><input type="text" class="form-control"
								name="content"></td>
							<td class="col-md-1"><h5>回复时间：</h5></td>
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${null!=btnAu['businessman/commentReply/add']}">
					<button type="button" class="btn btn-success" data-type="ajax"
						data-url="businessman/commentReply/add/init.jhtml?cid=${param.cid}"
						data-toggle="modal">
						<span class="icon-plus"></span>添加
					</button>
				</c:if>
				<c:if test="${null!=btnAu['businessman/commentReply/delete']}">
	...
	<script type="text/json" id="permissions">{update:'${btnAu['businessman/commentReply/update']}',del :'${btnAu['businessman/commentReply/delete']}'}</script>
	<jsp:include page="../common.jsp"></jsp:include>
	<script
		src="<%=path%>/resources/zui/lib/datetimepicker/datetimepicker.min.js"></script>
	<script src="<%=path%>/js/businessman/commentReply.js"></script>
</body>
</html>
