...
<html class="screen-desktop-wide device-desktop" lang="zh-CN">
  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							...
							<td style="width:18%;">
								<select class="form-control" name="applytype" style = "width:83%;">
									<option value="">全部</option>
									<option value="1">申请开通会员卡</option>
									<option value="2">申请修改使用说明</option>
								</select>
							</td>
						  	<td style="width:5%;"><h5>审核状态:</h5></td>
						 	<td style="width:18%;">
								<select class="form-control" name="applystatus" style = "width:83%;">
									<option value="">全部</option>
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${null!=btnAu['businessman/vipCard/updateState'] && btnAu['businessman/vipCard/updateState']}">
	   ...
	   <div class="modal-dialog">
	      <div class="modal-content">
	         ...
	         <div class="modal-body">
				...
				<input type="hidden"   id = "applystatus" name="applystatus" value="">
	...
	<script src="<%=path%>/js/businessman/vipCard/vipCardAudit.js"></script>
