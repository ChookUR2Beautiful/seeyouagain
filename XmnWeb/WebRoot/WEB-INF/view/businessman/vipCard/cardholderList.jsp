...
<html class="screen-desktop-wide device-desktop" lang="zh-CN">
  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
				...
				<table style="width:100%;">
					<tbody>
						...
						<tr>
							...
							<td style="width:14%;"><input type="text" class="form-control"  name="msellerId" style = "width:90%;"/></td>
							<td style="width:5%;"><h5>商家名称:</h5></td>
							<td style="width:18%;"><input type="text" class="form-control"  name="msellerName" style = "width:90%;"/></td>
	...
	<script type="text/json" id="permissions">{detail:'${ btnAu['businessman/vipCard/details']}',lock:'${ btnAu['businessman/vipCard/lock']}'}</script>
	<jsp:include page="../../common.jsp"></jsp:include>
	<script src="<%=path%>/resources/zui/lib/chosen/chosen.js"></script>
	<script src="<%=path%>/js/businessman/vipCard/listCardholder.js"></script>
