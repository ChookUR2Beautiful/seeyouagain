...
<body
		...
		<div class="panel-body">
			<form class="form-horizontal" role="form"  id="userForm">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							<td style="width:5%;"><h5>&nbsp;&nbsp;优惠券编码:</h5></td>
							<td style="width:25%;">
								<input type="text" class="form-control"  id="serialNo" name="serialNo"  style="width:90%">
							</td>
							<td style="width:5%;"><h5>&nbsp;&nbsp;会员手机号:</h5></td>
							<td style="width:25%;">
								<input type="text" class="form-control"  id=phone name="phone"  style="width:90%">
							</td>
							<td style="width:5%;"><h5>&nbsp;&nbsp; 领取时间:</h5></td>							
							<td style="width:25%;">
							...
							<tr>
							<td style="width:5%;"><h5>&nbsp;&nbsp;优惠券状态:</h5></td>
	...
	<script type="text/json" id="permissions">{init:'${btnAu['businessman/fullReduction/init']}',list:'${btnAu['businessman/fullReduction/list']}',detail:'${btnAu['businessman/fullReduction/detail']}',shutdown:'${btnAu['businessman/fullReduction/shutdown']}'}</script>
	<jsp:include page="../../common.jsp"></jsp:include>
	<script src="<%=path%>/resources/zui/lib/chosen/chosen.js"></script>
	<script src="<%=path%>/resources/zui/lib/datetimepicker/datetimepicker.min.js"></script>
	<script src="<%=path%>/js/businessman/coupon/giftCouponDetailList.js"></script>
