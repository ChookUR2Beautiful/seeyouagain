...
<body
	...
	<input type="hidden" id="path" value="<%=path%>" />
		...
		<div class="panel-body">
			<form class="form-horizontal" role="form"  id="fullReductionForm">
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			...
			<div id="fullReductionDiv"></div>
		</div>
	</div>
	</div>
	<script type="text/json" id="permissions">{list:'${btnAu['businessman/fullReduction/init/list']}',shutdown:'${btnAu['businessman/fullReduction/shutdown']}'}</script>
	<jsp:include page="../../common.jsp"></jsp:include>
	<script src="<%=path%>/resources/zui/lib/chosen/chosen.js"></script>
	<script src="<%=path%>/ux/js/ld2.js"></script>
	<script src="<%=path%>/resources/zui/lib/datetimepicker/datetimepicker.min.js"></script>
	<script src="<%=path%>/js/businessman/coupon/FullReductionList.js"></script>
