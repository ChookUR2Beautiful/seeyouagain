...
<body
	...
	<input type="hidden" id="path" value="<%=path%>" />
		...
		<div class="panel-body">
			<form class="form-horizontal" role="form"  id="sellerCouponForm">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							...
							<td style="width:25%;">
								<input type="text" class="form-control"  id="cname" name="cname"  style="width:90%">
							</td>
							...
							<td style="width:25%;"><select style="width:90%" 
									class="form-control" id="sendStatus" name="sendStatus">
										<option value="">全部</option>
										<option value="1">进行中</option>
										<option value="2">已结束</option>
										<option value="3">活动占用</option>
								</select></td>
							<td></td>
							<td></td>
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			...
			<div id="sellerCouponDiv"></div>
		</div>
	</div>
	</div>
	<script type="text/json" id="permissions">{list:'${btnAu['businessman/coupon/list']}',shutdown:'${btnAu['businessman/coupon/shutdown']}'}</script>
	<jsp:include page="../../common.jsp"></jsp:include>
	<script src="<%=path%>/resources/zui/lib/chosen/chosen.js"></script>
	<script src="<%=path%>/ux/js/ld2.js"></script>
	<script src="<%=path%>/resources/zui/lib/datetimepicker/datetimepicker.min.js"></script>
	<script src="<%=path%>/js/businessman/coupon/giftCouponList.js"></script>
