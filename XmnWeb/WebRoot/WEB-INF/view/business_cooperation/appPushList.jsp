...
<html lang="zh-CN">
  ...
  <body  style="overflow-x: auto;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${null!=btnAu['business_cooperation/appPush/add'] && btnAu['business_cooperation/appPush/add']}"><button type="button" class="btn btn-success"  data-type="ajax" data-url="business_cooperation/appPush/add/init.jhtml" data-toggle="modal" ><span class="icon-plus"></span>&nbsp;添加</button>
				</c:if>
				<c:if test="${null!=btnAu['business_cooperation/appPush/delete'] && btnAu['business_cooperation/appPush/delete']}"><button type="button" class="btn btn-danger" id="delete"><span class="icon-remove"></span>&nbsp;删除</button>
				</c:if>
				<c:if test="${null!=btnAu['business_cooperation/appPush/export'] && btnAu['business_cooperation/appPush/export']}"><button type="button" id="export" class="btn btn-default" ><span class="icon-download-alt"></span>&nbsp;导出</button>
				</c:if>
				<!-- <div class="btn-group">
	...
	<script type="text/json" id="permissions">{del:'${btnAu['business_cooperation/appPush/delete'] }',export:'${btnAu['business_cooperation/appPush/export'] }',update :'${btnAu['business_cooperation/appPush/update'] }'}</script>
	<jsp:include page="../common.jsp"></jsp:include>
	<script src="<%=path%>/resources/zui/lib/datetimepicker/datetimepicker.min.js"></script>
	<script src="<%=path%>/js/business_cooperation/appPush.js"></script>
  </body>
</html>
