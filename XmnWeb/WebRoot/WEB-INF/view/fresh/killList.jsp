				...
				<table style="width:100%;">
					<tbody>
						<tr>
							...
							<td style="width:18%;">
									<input type="text" class="form-control" name="startTime" value="" onFocus="WdatePicker({maxDate:new Date(),dateFmt:'yyyy-MM-dd'})" onchange="" style="width:42%;float:left" readonly="readonly"/>
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${null!=btnAu['fresh/kill/add']}">
					<a type="button" class="btn btn-success"  href="fresh/kill/add/init.jhtml" ><span class="icon-plus"></span>&nbsp;添加活动</a>
				</c:if>
...
{
	add:'${ btnAu['fresh/kill/add']}',
	end:'${btnAu['fresh/kill/end']}',
	delete:'${btnAu['fresh/kill/delete']}',
	edit:'${btnAu['fresh/kill/edit/init']}'
}</script>
	...
	<script src="<%=path%>/js/fresh/killList.js"></script>
	<!-- 引入时间插件 -->
