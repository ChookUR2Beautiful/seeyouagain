...
<body
	...
	<div class="tab-content">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="divideForm">
						<input type="hidden" name="type" value="0" /> <input
							type="hidden" name="destroy" value="1" />
			...
			<div class="panel panel-default">
				<div class="panel-body data">
					<div class="btn-group" style="margin-bottom: 5px;">
						<%-- <c:if test="${null!=btnAu['businessman/sellerAccount/add']}"><button type="button" class="btn btn-success" id="divideAgree" >通过</button></c:if>
			<c:if test="${null!=btnAu['businessman/sellerAccount/delete']}"><button type="button" class="btn btn-danger" id="divideDisagree">不通过</button></c:if> --%>
					</div>
					<div id="divide"></div>
				</div>
			</div>
		...
		<div id="tab2" class="tab-pane">
							...
							<tbody>
								<tr>
									...
									<td class="col-md-3">
										<div class="input-group">
											<input type="text" placeholder="yyyy-MM-dd hh:mm"
												class="form-control form_datetime" name="startTime" /> <span
			...
			<div class="panel panel-default">
				<div class="panel-body data">
					<div class="btn-group" style="margin-bottom: 5px;">
						<%-- <c:if test="${null!=btnAu['businessman/sellerAccount/add']}"><button type="button" class="btn btn-success" id="withdrawAgree" >通过</button></c:if>
			<c:if test="${null!=btnAu['businessman/sellerAccount/delete']}"><button type="button" class="btn btn-danger" id="withdrawDisagree">不通过</button></c:if> --%>
					</div>
					<div id="withdraw"></div>
	...
	<script src="<%=path%>/js/president_office/destructionOrder.js"></script>
</body>
</html>