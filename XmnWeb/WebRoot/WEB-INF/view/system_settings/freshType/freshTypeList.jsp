...
<body style="overflow-x: auto;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
	<ul id="myTab" class="nav nav-tabs">
		<c:if test="${null!=btnAu['system_settings/category/init/list'] && btnAu['system_settings/category/init/list']}">
			<li class=""><a href="system_settings/category/init.jhtml">发现美食</a></li>
		</c:if>
		<li class="active"><a>积分商城</a></li>
	</ul>
