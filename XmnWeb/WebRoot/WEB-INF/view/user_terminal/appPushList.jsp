...
<html lang="zh-CN">
  ...
  <body  style="overflow-x: auto;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
			...
			<form class="form-horizontal" role="form" method="post"  id="searchForm">
				<table style="width:100%;">
					<tbody>
						...
						<tr>						    
							<td style="width:50px;"><h5>&nbsp;&nbsp;发送对象</h5></td>
						...
						<tr>
							<td colspan="8"><div class="submit"><input class="submit radius-3" type="button"  value="查询全部sss"  data-bus = 'query' /><input  class="reset radius-3" type="reset" value="重置全部"   data-bus = 'reset' /></div></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${null!=btnAu['user_terminal/appPush/add'] && btnAu['user_terminal/appPush/add']}"><button type="button" class="btn btn-success"  data-type="ajax" data-url="user_terminal/appPush/add/init.jhtml" data-toggle="modal" ><span class="icon-plus"></span>&nbsp;添加</button>
				</c:if>
			<%-- 	<c:if test="${null!=btnAu['user_terminal/appPush/delete'] && btnAu['user_terminal/appPush/delete']}"><button type="button" class="btn btn-danger" id="delete"><span class="icon-remove"></span>&nbsp;删除</button>
				</c:if> --%>
				<c:if test="${null!=btnAu['user_terminal/appPush/export'] && btnAu['user_terminal/appPush/export']}"><button type="button" id="export" class="btn btn-default" ><span class="icon-download-alt"></span>&nbsp;导出</button>
				</c:if>
				<!-- <div class="btn-group">
	...
	<script type="text/json" id="permissions">{<%--del:'${btnAu['user_terminal/appPush/delete'] }',--%>update :'${btnAu['user_terminal/appPush/update'] }'}</script>
	<jsp:include page="../common.jsp"></jsp:include>
	<script src="<%=path%>/resources/zui/lib/datetimepicker/datetimepicker.min.js"></script>
	<script src="<%=path%>/js/user_terminal/appPush.js"></script>
  </body>
</html>
