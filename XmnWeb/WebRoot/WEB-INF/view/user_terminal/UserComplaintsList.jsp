...
<html lang="zh-CN">
  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							...
							<td style="width:6%;"><h5>&nbsp;&nbsp;投诉对象:</h5></td>
	...
	<script type="text/json" id="permissions">{update:'${ btnAu['user_terminal/userComplaints/update']}'<%--,del:'${btnAu['user_terminal/advertising/delete'] }'--%>}</script>
	<jsp:include page="../common.jsp"></jsp:include>
	<script src="<%=path%>/resources/zui/lib/chosen/chosen.js"></script>
	<script src="<%=path%>/ux/js/ld2.js"></script>
	<script src="<%=path%>/ux/js/scrollTablel.js"></script>
	<script src="<%=path%>/js/user_terminal/UserComplaintsList.js"></script>
