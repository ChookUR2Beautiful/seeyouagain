...
<body>
		...
		<tbody>
			<tr>
				...
				<!-- 1=Android|2=Ios|3=Wp|4=其他 -->
					...
					<td>
						<input type="hidden" name="vtype" value="3"> 
						<select class="form-control"  disabled="disabled">
							<option selected="selected">WP</option>
						</select>
					</td>
				</tr>
				...
				<!-- 1=已发布|2=停止更新 -->
					...
					<td>
			<%-- 		<input type="text" class="form-control"  name="id"  value="${appVersion.status}"> --%>
				...
				<tr>
					<%-- <th style="width:90px;"><h5>&nbsp;&nbsp;URL地址</h5></th>	
					<th colspan="2"><input type="text" class="form-control"  name="url"  value="${appVersion.url}"></th> --%>
					<th class="w-100px">文件:</th>
					<td >
						<div class="col-md-9">
						<div id='urldivs' ImgValidate="true"></div>
							<input type="hidden" id="urlids" name = "url" value = "${appVersion.url}"/>		
						</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
					<%-- <input type="text" class="form-control"  name="id"  value="${appVersion.content}"> --%>
	...
	function startValidate(){
		...
		function formAjax(){
			var data = jsonFromt($('#editAppVersionForm').serializeArray());
			if(!valiImgData('#editAppVersionForm',data)){
				var url ;
				if($('#isType').val() ==  'add'){
