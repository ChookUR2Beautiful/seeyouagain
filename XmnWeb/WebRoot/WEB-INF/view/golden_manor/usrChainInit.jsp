...
<form id="videoFrom" role="form" class="form-horizontal">
	...
	<div class="form-group">
		<label class="col-md-4 control-label">用户上级：<span
			style="color:red;">*</span></label>
	...
	<div class="form-group">
		<label class="col-md-4 control-label">绑定上级：<span
			style="color:red;">*</span></label>
		<div class="col-md-7">
...
<script src="<%=path%>/js/golden_manor/usrChainInit.js"></script>
</body>
