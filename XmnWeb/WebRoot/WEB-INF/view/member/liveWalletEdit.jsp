...
<body>
	<form id="editFrom" role="form" class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-md-4 control-label">锁定鸟币：<span style="color:red;">*</span></label>
			<div class="col-md-7">
				<input name="updateOption" value="0" type="radio" ${memberWalletInfo.liveZbalanceLock=="true"?"checked":""} ><span style="font-size: 12px;">锁定</span>
				<input name="updateOption" value="1" type="radio" ${memberWalletInfo.liveZbalanceLock=="false"?"checked":""} ><span style="font-size: 12px;">解锁</span>
			</div>
		</div>
	...
	<script src="<%=path%>/js/member/liveWalletEdit.js?v=1.0.11"></script>
</body>
</html>
