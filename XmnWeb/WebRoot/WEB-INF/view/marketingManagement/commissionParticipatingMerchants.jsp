...
,exitActivity:'${btnAu['marketingManagement/activityManagement/discount/initSellerRelateNum/discountExitActivity'] }'}</script> -->
	...
	<script type="text/json" id="permissions">
{update:'${btnAu['businessman/sellerPending/update'] }',view:'${btnAu['businessman/sellerPending/getInit'] }',agio:'${btnAu['businessman/sellerPendingAgio/init'] }'
,account:'${btnAu['businessman/sellerPendingAccount/init'] }',updateIsattend:'${btnAu['marketingManagement/activityManagement/commission/updateSellerMarketingIsAttend'] }'
,exitActivity:'${btnAu['marketingManagement/activityManagement/commission/commissionExitActivity'] }'}</script>
	...
	<script
		src="<%=path%>/js/marketingmanagement/commissionParticipatingMerchants.js"></script>
	<script type="text/javascript">
