...
<body>
	<div class="module-containner-wrap container-fluid">
	    ...
	    <!-- 物料模板Id -->
	    <input type="hidden" id="materialCarouselId" name="id" value="${materialCarouselId }">
	    <br><br><br>
	    <div class="row">
	    		<div class="col-lg-12 col-xs-12 mg-b-10">
	                <div class="good-template-bg-module">
	                    <div class="reset-form-name"><em class="em-tips-font">*</em>模板名称：</div>
	                    ...
	                    <div class="col-lg-2 col-xs-2 text-left">
	                        <input type="text" class="form-control"  id="goodimgWidth" name="goodimgWidth"/>
	                    </div>
	                    <div class="col-lg-2 col-xs-2 text-left">
	                        <input type="text" class="form-control"  id="goodimgHeight" name="goodimgHeight"/>
	                    </div>
	                    <div class="col-lg-2 col-xs-2 text-left">
	                        <button type="button" class="btn btn-primary" id="btn-imgPreserve">保存</button>
	                    </div>
	                </div>
	            </div>
	            <div class="col-lg-12 col-xs-12 mg-b-10">
	                <div class="good-template-bg-module">
	                    ...
	                    <div class="col-lg-12 col-xs-12 text-left">
	                        <input type="hidden" class="form-control" id="picUrl" name="source[0].picUrl"  value="">
	                        <input type="hidden" class="form-control" id="imgSize" name="source[0].imgSize"  value="200X200">
	                        <input type="hidden" class="form-control" id="type" name="source[0].type"  value="001">
	                        <input type="hidden" class="form-control" id="imgType" name="source[0].imgType"  value="003">
    ...
    <script src="<%=path%>/js/cloud_design/materialTemplateEdit.js"></script> 
</body>
</html>