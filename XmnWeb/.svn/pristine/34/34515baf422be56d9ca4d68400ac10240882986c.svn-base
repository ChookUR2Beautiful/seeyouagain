...
$(document).ready(function() {
	sellerAccountList = $('#sellerAccountList').page({
		url : 'businessman/allianceShop/subShop/list.jhtml',
		success : success,
		pageBtnNum : 10,
		paramForm : 'searchForm'
	});
	
	inserTitle(' > <a href="businessman/allianceShop/subShop/init.jhtml?fatherid='+$("#id")+'" target="right">关联商户</a>','sellerAccounList',false);
});
