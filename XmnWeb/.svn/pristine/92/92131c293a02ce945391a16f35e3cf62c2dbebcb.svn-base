...
<body
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if
					test="${null!=btnAu['anchorBusiness/manage/anchorImage'] && btnAu['anchorBusiness/manage/anchorImage']}">
					<button type="button" class="btn btn-success" data-type="ajax"
						data-title="添加图文页" data-url="anchorBusiness/manage/anchorImage/addPhoto/init.jhtml?anchorId=${anchorId }"
	...
	<script src="<%=path%>/js/live_anchor/anchorImageManage.js?v=1.0.4"></script>
</body>
</html>
