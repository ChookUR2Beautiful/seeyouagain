...
<div id="prompt" style="position: fixed; height: 100%; width: 100%; z-index: 9; background: url(resources/page/loading.gif) #FFF no-repeat center; filter: alpha(opacity =  50); opacity: 0.5; display: none;"></div>
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			...
			<c:if test="${null!=btnAu['businessman/multipShop/bindCardInit/addCardInit']}">
				<button type="button" class="btn btn-success"  data-type="ajax" data-url="businessman/allianceShop/bindCardInit/addCardInit.jhtml?sellerid=${param.sellerid }&sellername=
<%=URLEncoder.encode(request.getParameter("sellername"), "UTF-8") %>"  data-toggle="modal" ><span class="icon-plus"></span>&nbsp;添加</button>
		...
		{xg:'${ btnAu['businessman/multipShop/bindCardInit/updateCardInit']}'}
    </script>
	...
	<script src="<%=path%>/js/businessman/allianceShop/bindAllianceCardInit.js"></script>
  </body>
</html>
