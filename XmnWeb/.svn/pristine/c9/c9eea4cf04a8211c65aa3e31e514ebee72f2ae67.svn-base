...
dialogWithbtn.prototype.init = function(){
	var diaHtml = '<div class="confirmdiagmodal"></div><div class="dialogwithbtn-box"><h3>'+this.title+'</h3><p class="dialogwithbtn-tips">'+this.content+'</p><div class="dialogwithbtn-btnbox"><a href="javascript:;" class="dialogwithbtn-cancel" data-ajax="false">取消</a><a href="javascript:;" class="dialogwithbtn-confirm" data-ajax="false">确认兑换</a></div></div>';
	$('body').append(diaHtml);
	var _this = this;
