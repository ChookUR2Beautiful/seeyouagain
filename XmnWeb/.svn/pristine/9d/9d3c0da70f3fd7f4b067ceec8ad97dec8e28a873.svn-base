		...
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				...
				<c:if test="${null!=btnAu['anchor/manage/add/init'] && btnAu['anchor/manage/add/init']}">
					...
					<button type="button" id="exportFailingBtn" class="btn btn-default" ><span class="icon-download-alt"></span>&nbsp;导出无效信息</button>
				</c:if>
				...
				<c:if test="${!empty btnAu['anchor/manage/configureFans'] && btnAu['anchor/manage/configureFans']}">
						<button type="button" class="btn btn-info" id="configureFansBatch" >&nbsp;配置粉丝</button>
				</c:if>
			</div>
