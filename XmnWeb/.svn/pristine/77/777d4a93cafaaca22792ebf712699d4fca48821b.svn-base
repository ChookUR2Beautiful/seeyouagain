  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
  	...
  	<div class="panel">
		<div class="panel-body">
			<form class="form-horizontal" role="form" method="post" id="searchFirstBillForm">
				<table style="width:100%;">
					<tbody>
						<tr>
							...
							<td style="width:19%;"><input type="text" class="form-control"  name="stringBid" style = "width:93%;"></td>
							<td style="width:5%;"><h5>订单状态:</h5></td>
							<td style="width:23%;">
								<select class="form-control" name="status" style = "width:93%;">
						...
						<tr>
							...
							<td style="width:19%;">
									<input type="text" name ="zdateStart" placeholder="yyyy-MM-dd hh:mm" class="form-control form-datetime"style="width:43%;float:left">
									<label style="float: left;">&nbsp;--&nbsp;</label>
									<input type="text" name ="zdateEnd" placeholder="yyyy-MM-dd hh:mm" class="form-control form-datetime" style="width:43%;float:left">
							</td>
							<td style="width:5%;"><h5>支付方式:</h5></td>
							        <td style="width:23%;"  >
								     <select class="form-control" name="paytype" style = "width:93%;">
										<option value="">请选择</option>
						...
						<tr>
						  ...
						  <td style="width:19%;"><input type="text" class="form-control"  name="uid" style = "width:93%;"></td>
						  <td style="width:5%;"><h5>订单金额:</h5></td>
						  <td style="width:23%;">
						  <input type="text" class="form-control"  name="moneyStart"  style="width:44%;float:left">
						    <label style="float: left;">&nbsp;--&nbsp;</label>
						  <input type="text" class="form-control"  name="moneyEnd"  style="width:44%;float:left">
						</td>	
						</tr>
						<tr>
						    <td style="width:5%;"></td><td style="width:19%;"></td>
						    <td style="width:5%;"></td><td style="width:19%;"></td>
						    <td style="width:5%;"></td><td style="width:19%;"></td>
							<td colspan="2"><div class="submit"><input class="submit radius-3" type="button"  value="查询全部"  data-bus = 'query' /><input  class="reset radius-3" type="reset" value="重置全部"   data-bus = 'reset' /></div></td>						
						</tr>
					</tbody>
				</table>
			</form>
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${null!=btnAu['billmanagerment/firstbill/export'] && btnAu['billmanagerment/firstbill/export']}"><button type="button" id="export" class="btn btn-default" ><span class="icon-download-alt"></span>&nbsp;excel导出</button>
				</c:if>
			</div>
			<div id="firstBillList"></div>
		</div>
	</div>
	<script type="text/json" id="permissions">{detail:'${ btnAu['billmanagerment/firstbill/view/init']}'}</script>
	<jsp:include page="../common.jsp"></jsp:include>
	<script src="<%=path%>/resources/zui/lib/chosen/chosen.js"></script>
	<script src="<%=path%>/ux/js/ld2.js"></script>
	<script src="<%=path%>/js/billmanagerment/firstBillList.js"></script>
