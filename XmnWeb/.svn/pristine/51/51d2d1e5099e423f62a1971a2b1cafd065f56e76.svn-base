  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
  	...
  	<div class="panel">
		<div class="panel-body">
			...
			<input type="hidden" id="uidtogetpart" name="uidtogetseller" value="${uidtogetseller}" />
			<input type="hidden" name="saasType" value="${saasType}" />
				<table style="width:100%;">
					<tbody>
						<tr>
							<td style="width:5%;"><h5>商铺编号:</h5></td>
							<td style="width:18%;"><input type="text" class="form-control" id="sellerid" name="sellerid" style = "width:90%;"/></td>
							<td colspan="2" style="width:5%;"></td>
							<td style="width:5%;"><h5>商铺名称:</h5></td>
							<td style="width:18%;">
							<input type="text" class="form-control" id="sellername" name="sellername" style = "width:90%;"/>
							</td>
							<td style="width:5%;"><h5>商铺状态:</h5>
							</td>
							<td style="width:18%;">
						...
						<tr>
							<td style="width:5%;"><h5>类别:</h5></td>
							<td style="width:18%;">
							<input type="text" class="form-control" id="typename" name="typename" style = "width:90%;"/>
							</td>
							<td  colspan="2" style="width:5%;"><h5></h5></td>
						 	<td style="width:5%;"><h5>签约日期:</h5></td>
							<td style="width:18%;">
...
idp:'${btnAu['user_terminal/banner/update']}'}
	...
	<script src="<%=path%>/js/xmermanagerment/xmerSellerList.js"></script>
