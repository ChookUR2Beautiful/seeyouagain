...
public class DivisionService extends BaseService<Division>{
	...
	private Integer addDivisionRegions(Division division, List<String> cityIds) {
		List<TArea> areas=areaService.getTownsByCityIds(cityIds);
	 ...
	 * 方法描述：获取赛区基础信息 <br/>
	 * 创建人：  huang'tao <br/>
	 * 创建时间：2017-6-19下午3:19:12 <br/>
	 * @param division
	 * @return
	 */
	public List<Division> getBaseList(Division division){
		return divisionDao.getBaseList(division);
	}
