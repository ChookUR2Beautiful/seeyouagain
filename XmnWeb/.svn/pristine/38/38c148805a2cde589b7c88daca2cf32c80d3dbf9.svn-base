  ...
  <body
					...
					<tbody>
						<tr>
							...
							<td  style="text-align: right; ">
								...
								<input  class="reset radius" type="reset" value="重置全部" onclick="rest()"  data-bus = 'reset' />
								</div>
							</td>			
						</tr>
					</tbody>
	...
	<div class="panel">
		<div class="panel-body data">
			<div id="memberActionDiv" request-init ="${requestInit}">
	...
	var mem= $('#memberActionDiv');
		$(function(){
			inserTitle(' > 用户端数据统计  > 会员行为','memberAction',true);
