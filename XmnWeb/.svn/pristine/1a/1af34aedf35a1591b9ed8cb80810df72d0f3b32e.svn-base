  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			...
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${btnAu['usercv/manage/export']}"><button type="button" id="export" class="btn btn-default" ><span class="icon-download-alt"></span>&nbsp;导出</button>
				</c:if>
				<c:if test="${btnAu['usercv/manage/delete']}"><button type="button" class="btn btn-danger" id="delete"><span class="icon-remove"></span>&nbsp;删除</button>
				</c:if>
			</div>
			<div id="userCVList"></div>
		</div>
	</div>
     <!-- 操作结果提示层 -->
	...
	<script src="<%=path%>/js/jobmanage/userCvList.js"></script>
