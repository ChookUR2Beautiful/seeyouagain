  ...
  <body  style="overflow-x: hidden;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
  	...
  	<div class="panel">
		<div class="panel-body">
			...
			<input type="hidden" id="uidtogetpart" name="uidtogetpart" value="${uidtogetpart}" />
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			...
			<div id="indirectPartnerList"></div>
		</div>
	</div>
     <!-- 操作结果提示层 -->
...
idp:'${btnAu['user_terminal/banner/update']}'}
	...
	<script src="<%=path%>/js/xmermanagerment/indirectPartherList.js"></script>
