...
function success4(data, obj) {
	...
	var callbackParam="isBackButton=true&callbackParam="+getFormParam($("#searchForm4").serialize());
...
$("#export4").click(function(){
		...
		$form = $("#searchForm4").attr("action",url);
		$form[0].submit();
	});
