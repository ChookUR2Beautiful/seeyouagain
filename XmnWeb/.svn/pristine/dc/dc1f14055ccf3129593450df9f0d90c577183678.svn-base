    ...
    private static class queryAdjBeforeOrderInfo_argsStandardScheme extends StandardScheme<queryAdjBeforeOrderInfo_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryAdjBeforeOrderInfo_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.paraMap != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.paraMap.size()));
            for (Map.Entry<String, String> _iter112 : struct.paraMap.entrySet())
            {
    ...
    private static class queryAdjBeforeOrderInfo_argsTupleScheme extends TupleScheme<queryAdjBeforeOrderInfo_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, queryAdjBeforeOrderInfo_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetParaMap()) {
          {
            oprot.writeI32(struct.paraMap.size());
            for (Map.Entry<String, String> _iter113 : struct.paraMap.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.paraMap = new HashMap<String,String>(2*_map114.size);
            for (int _i115 = 0; _i115 < _map114.size; ++_i115)
            {
              ...
              struct.paraMap.put(_key116, _val117);
            }
          }
          struct.setParaMapIsSet(true);
        }
    ...
    private static class handleLedger_argsStandardScheme extends StandardScheme<handleLedger_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, handleLedger_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.paraMap != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.paraMap.size()));
            for (Map.Entry<String, String> _iter132 : struct.paraMap.entrySet())
            {
    ...
    private static class handleLedger_argsTupleScheme extends TupleScheme<handleLedger_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, handleLedger_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetParaMap()) {
          {
            oprot.writeI32(struct.paraMap.size());
            for (Map.Entry<String, String> _iter133 : struct.paraMap.entrySet())
            {
    ...
    private static class handleLedger_resultStandardScheme extends StandardScheme<handleLedger_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, handleLedger_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.success.size()));
            for (Map.Entry<String, String> _iter142 : struct.success.entrySet())
            {
    ...
    private static class handleLedger_resultTupleScheme extends TupleScheme<handleLedger_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, handleLedger_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Map.Entry<String, String> _iter143 : struct.success.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashMap<String,String>(2*_map144.size);
