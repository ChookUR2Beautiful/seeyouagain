var recordList;
var historyList;
var initListUrl = "liveVideo/manage/init/list.jhtml";
			...
			cols : [ 
				{
					...
					linkInfo : {
						modal : {
							url : "liveVideo/manage/robotSet/privateRobotSet/init.jhtml",
							position : "",
							width : "auto",
							title : "直播间机器人配置"
						},
					...
					linkInfoName : "href",
					linkInfo : {
						href : "liveVideo/manage/update/init.jhtml",
						param : [ "id" ],
						permission : "update"
					}
				} , {
					...
					linkInfoName : "href",
					linkInfo : {
						href : "liveVideo/manage/enterChatRoom.jhtml",// url
						param : ["id"],// 参数
						permission : "enterChatRoom"// 列权限
					}
				 },{
						title : "置顶",// 标题
						linkInfoName : "href",
