	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${null!=btnAu['division/add']}">
					<a type="button" class="btn btn-success" data-position="0" data-toggle="modal"
							data-type="ajax"  data-url="division/add/init.jhtml" ><span class="icon-plus"></span>&nbsp;添加赛区</a>
				</c:if>
			</div>
...
{
	add:'${btnAu['division/add']}',
	edit:'${btnAu['division/update']}'
}</script>
	...
	<script src="<%=path%>/js/vstar/division/divisionList.js"></script>
	<!-- 引入时间插件 -->
