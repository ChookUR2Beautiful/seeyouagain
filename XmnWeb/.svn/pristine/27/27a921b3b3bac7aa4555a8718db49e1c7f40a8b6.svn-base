...
<body
							...
							<table style="width:100%;">
								<tbody>
									<tr>
										...
										<td style="width:25%;"><input type="text" class="form-control"  name="playerId" style = "width:85%;"></td>
										<td style="width:5%;"><h5>&nbsp;&nbsp;主播昵称:</h5></td>
										<td style="width:25%;"><input type="text" class="form-control"  name="playerName" style = "width:85%;"></td>
										<td style="width:5%;"><h5>手机号码:</h5></td>
										<td style="width:30%;"><input type="text" class="form-control"  name="playerPhone" style = "width:66%;"></td>
									</tr>
									<tr>
	...
	<script src="<%=path%>/js/vstar/videoManage/liveVideoManage.js?v=1.0.11"></script>
</body>
</html>
