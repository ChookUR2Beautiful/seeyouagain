	...
	<div class="panel panel-default">
		<div class="panel-body data">
			...
			<c:if test="${null!=btnAu['businessman/multipShop/bindCardInit/addCardInit']}">
				<button type="button" class="btn btn-success"  data-type="ajax" data-url="businessman/multipShop/bindCardInit/addCardInit.jhtml?sellerid=${param.sellerid }&sellername=
<%=URLEncoder.encode(request.getParameter("sellername"), "UTF-8") %>"  data-toggle="modal" ><span class="icon-plus"></span>&nbsp;添加</button>
	...
	<script src="<%=path%>/js/businessman/multipleshop/bindCardInit.js"></script>
  </body>
</html>
