 ...
 * 项目名称：XmnWeb_vstar
 * 
 * 类名称：VstarEnrollController
 * 
 * 类描述： 新时尚大赛报名Controller
 * 
 * 创建人：  huang'tao
 * 
 ...
 */
@Controller
@RequestMapping(value = "VstarEnroll/manage")
public class VstarEnrollController extends BaseController {
	...
	public String init() {
		return "vstar/vstarEnrollManage";
	}
	...
	public Object initList(TVstarEnroll vstarEnroll) {
		...
		Object json =null;
		try {
			List<TVstarEnroll> list = starEnrollService.getListInfo(vstarEnroll);
