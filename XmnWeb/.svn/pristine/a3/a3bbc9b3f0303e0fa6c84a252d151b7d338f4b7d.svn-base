;(function($){
	$.fn.extend({
		"PaginBar":function(divId,table,show_per_page){
			...
			var current_link = 0;
			var navigation_html = '<a class="previous_link" href="javascript:go_to_page(0);go_first();"><div id="first_page"> </div></a><a class="previous_link" href="javascript:;" onclick="previous(\''+table+'\',this);"><div> </div></a>';
			...
			navigation_html += '<a class="next_link" href="javascript:;" onclick="next(\''+table+'\',this);"><div> </div></a><a class="next_link" href="javascript:go_to_page(' + index_of_pages +');go_last();"><div id="last_page"> </div></a>';
			
			previous = function(table,_this){
				var num_box=$(_this).parent("[id^='page_navigation']").find(".num_box");
			...
			go_to_page = function(page_num,item){
				start_from = page_num * show_per_page;
				end_on = start_from + show_per_page;
				item.find("tr").css('display', 'none').slice(start_from, end_on).css({
					"display": "table-row",
					"width":"100%;"
				});
			...
			//$(".next_link").click(function(){next(tableId);})
