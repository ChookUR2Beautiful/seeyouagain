...
<html>
  ...
  <body  style="overflow-x: auto;overflow-y: auto;min-width: 1024px;background:#EEE" class="doc-views with-navbar">
		...
		<div id="tab1" class="tab-pane in active">
			...
			<div class="panel panel-default">
				<div class="panel-body data">
					...
					<c:if
						test="${null!=btnAu['vstarLiverContent/main/edit']}">
						<a type="button" class="btn btn-success" href="vstarLiverContent/main/edit/init.jhtml" >
							<span class="icon-plus"></span>&nbsp;添加视频教学
						</a>
					</c:if>
					
					<c:if
						test="${null!=btnAu['vstarLiverContent/range/edit']}">
						<a type="button" class="btn btn-success" href="vstarLiverContent/range/edit/init.jhtml" >
							<span class="icon-plus"></span>&nbsp;添加远程教学
						</a>
					</c:if>
					
					<c:if test="${!empty btnAu['vstarLiverContent/update']}">
	...
	<script type="text/json" id="permissions">
		{update:'${ btnAu['vstarLiverContent/update']}'}
    </script>
	<jsp:include page="../../common.jsp"></jsp:include>
	<script src="<%=path%>/ux/js/scrollTablel.js"></script>
	<script src="<%=path%>/js/vstar/vstarLiverContent/liverContentManage.js"></script>
  </body>
</html>
