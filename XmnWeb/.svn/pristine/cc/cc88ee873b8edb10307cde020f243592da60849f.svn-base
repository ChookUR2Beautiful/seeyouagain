...
<body
	...
	<div class="panel panel-default">
		<div class="panel-body data">
			<div class="btn-group" style="margin-bottom: 5px;">
				<c:if test="${btnAu['loseGift/giveBack']}">
						<button type="button" class="btn btn-default" id="giveBack_btn" ><i class="icon icon-plane"></i>&nbsp;归还鸟蛋
					   </button>
				</c:if>
			</div>
			<div id="giftList"></div>
	...
	<script src="<%=path%>/js/live_anchor/loseGiftList.js"></script>
</body>
</html>
