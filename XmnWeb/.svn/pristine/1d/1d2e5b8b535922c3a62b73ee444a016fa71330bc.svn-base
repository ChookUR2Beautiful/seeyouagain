...
public class ResponsePageList implements org.apache.thrift.TBase<ResponsePageList, ResponsePageList._Fields>, java.io.Serializable, Cloneable, Comparable<ResponsePageList> {
  ...
  private static class ResponsePageListStandardScheme extends StandardScheme<ResponsePageList> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ResponsePageList struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pageList = new ArrayList<Map<String,String>>(_list36.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ResponsePageList struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.pageList != null) {
        oprot.writeFieldBegin(PAGE_LIST_FIELD_DESC);
        {
          ...
          for (Map<String,String> _iter43 : struct.pageList)
          {
            {
  ...
  private static class ResponsePageListTupleScheme extends TupleScheme<ResponsePageList> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ResponsePageList struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPageList()) {
        {
          ...
          for (Map<String,String> _iter45 : struct.pageList)
          {
            {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ResponsePageList struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.pageList = new ArrayList<Map<String,String>>(_list47.size);
