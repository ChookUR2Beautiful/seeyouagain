...
<body>
	<form class="form-horizontal" role="form" id="userProposalForm">
...
<script type="text/javascript">	 
		 $(document).ready(function() {
			...
			function formAjax(){			
					var url='user_terminal/userProposal/update.jhtml' + '?t=' + Math.random();
					$.ajax({
						type : 'post',
						url : url,
						data : jsonFromt($('#userProposalForm').serializeArray()),
						dataType : 'json',
