...
<body
	...
	<script type="text/json" id="permissions">
      ...
      ,account:'${btnAu['businessman/sellerPendingAccount/init'] }',updateIsattend:'${btnAu['marketingManagement/activityManagement/manzeng/initSellerRelateNum/updateSellerMarketingIsattend'] }'
      ,exitActivity:'${btnAu['marketingManagement/activityManagement/manzeng/initSellerRelateNum/manzengExitActivity'] }'}
    </script>
	...
	<script src="<%=path%>/js/marketingmanagement/SellerRelateNumList.js"></script>
	<script type="text/javascript">
