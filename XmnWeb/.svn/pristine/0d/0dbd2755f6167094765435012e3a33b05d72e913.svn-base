...
public class FreePatchUtil {  
    ...
    public static String patchFile="C:\\Users\\Administrator\\Desktop\\patch0915.txt";//补丁文件,由eclipse svn plugin生成  
      
    public static String projectPath="E:\\workspace\\XmnWeb";//项目文件夹路径  
      
    public static String webContent="WebContent";//web应用文件夹名  
      
    public static String classPath="D:\\Program Files\\apache-tomcat-7.0.42\\webapps\\XmnWeb\\WEB-INF\\classes";//class存放路径  
      
    public static String desPath="C:\\Users\\Administrator\\Desktop\\update_pkg";//补丁文件包存放路径  
      
    public static String version="2017091501";//补丁版本  
