...
<body
	...
	<script type="text/json" id="permissions">
      ...
      ,account:'${btnAu['businessman/sellerPendingAccount/init'] }',updateIsattend:'${btnAu['marketingManagement/activityManagement/scratchCard/initSellerRelateNum/updateSellerMarketingIsattend'] }'
      ,exitActivity:'${btnAu['marketingManagement/activityManagement/scratchCard/initSellerRelateNum/scratchCardExitActivity'] }'}
    </script>
	...
	<script
		src="<%=path%>/js/marketingmanagement/scratchCardSellerRelateNumList.js"></script>
	<script type="text/javascript">
