...
<body
	...
	<div class="panel">
		<div class="panel-body">
			<div class="btn-group">
			<c:if test="${!empty btnAu['businessman/classify/add'] }">
				<button type="button" class="btn btn-success" data-type="ajax"
					data-url="businessman/classify/add/init.jhtml" data-toggle="modal"><span class="icon-plus"></span>&nbsp;添加标签</button>
			</c:if>
			</div>
...
<script type="text/json" id="permissions">{
	  add:'${ btnAu['businessman/classify/add']}'
	}</script>
...
<script type="text/javascript" src="<%=path%>/js/businessman/classify/classifyList.js"></script>
</html>
