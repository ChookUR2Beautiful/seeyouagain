...
function success2(data, obj) {
	...
	var callbackParam="isBackButton=true&callbackParam="+getFormParam($("#searchForm2").serialize());
...
$("#export2").click(function(){
		...
		$form = $("#searchForm2").attr("action",url);
		$form[0].submit();
	});
