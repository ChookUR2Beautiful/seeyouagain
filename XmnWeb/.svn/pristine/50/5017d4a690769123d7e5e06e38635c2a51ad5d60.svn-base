var recordList;
var initListUrl = "saasArticle/manage/init/list.jhtml";
var imgRoot = $("#fastfdsHttp").val();
$(function() {
	inserTitle(
			' > 商家端数据统计 > <a href="saasArticle/manage/init.jhtml" target="right">文章管理</a>',
			'userSpan', true);
	...
	$("#export").click(function(){
		var path="saasArticle/manage/export.jhtml";
...
function success(data, obj) {
	var formId = "shareForm", title = "文章列表", subtitle = "个文章";
			...
			cols : [ 
		         {
					...
					linkInfoName : "href",
					linkInfo : {
						href : "saasArticle/manage/update/init.jhtml",
						param : [ "id" ],
						permission : "update"
					}
				} 
 ...
 $('#delete').click(function(){
 	...
 	showSmConfirmWindow(function() {
 		$.ajax({
 			type : 'post',
 			url : 'saasArticle/manage/delete.jhtml' + '?t=' + Math.random(),
 			data : 'ids=' + ids,
 			dataType : 'json',
 ...
 */
 function updateBatch(data,title){
 	showSmConfirmWindow(function() {
 					$.ajax({
 				        type: "POST",
 				        url: "saasArticle/manage/updateBatch.jhtml",
 				        data: data,
 				        dataType: "json",
