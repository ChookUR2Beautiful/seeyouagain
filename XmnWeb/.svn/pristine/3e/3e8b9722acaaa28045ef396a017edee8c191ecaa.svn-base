...
public class PluploadUtil {
	 ...
	 * @throws IOException
	 */
	public static File upload(Plupload plupload, File dir) throws IllegalStateException, IOException {
		// 生成唯一的文件名
	 ...
	 * @throws IOException
	 */
	public static File  upload(Plupload plupload, File dir, String filename) throws IllegalStateException, IOException {
