...
<style type="text/css">
	#recordList1 table td{
		text-overflow: initial;/**initial*/
	}
</style>
</head>
...
<body
	...
	<ul id="myTab" class="nav nav-tabs">
		...
		<li class=""><a href="#tab2" data-toggle="tab">通告</a></li>
			...
			<div class="panel-body data">
				<div class="btn-group" style="margin-bottom: 5px;">
					<c:if
						...
						<a type="button" class="btn btn-success"  href="liveRecord/manage/addBatch/init.jhtml" ><span class="icon-plus"></span>&nbsp;添加预告</a>
					</c:if>
					<c:if
						test="${null!=btnAu['liveRecord/manage/addBatch'] && btnAu['liveRecord/manage/add']}">
						<a type="button" class="btn btn-success"  href="liveRecord/manage/addOrderRecord/init.jhtml" ><span class="icon-plus"></span>&nbsp;添加通告</a>
					</c:if>
